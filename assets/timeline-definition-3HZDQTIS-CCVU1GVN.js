...
var g = "",
  ...
  k = t(() => l, "getCommonDb"),
  _ = t(function () {
    ((m.length = 0), (x.length = 0), (g = ""), (b.length = 0), h());
  }, "clear"),
  w = t(function (t) {
    ((g = t), m.push(t));
  }, "addSection"),
  ...
  O = t(function (t, e, n) {
    ...
    (s
      ...
      .attr("stroke", "#666"),
      A(s, { cx: i, cy: 300 + 30 * (5 - e.score), score: e.score }));
    const r = z();
    ((r.x = e.x),
      (r.y = e.y),
      (r.fill = e.fill),
...
var V = t(function (t, e, n, i) {
  ...
  Y = t(function (t, r, a, o) {
    const c = e(),
      l = c.timeline?.leftMargin ?? 50;
    n.debug("timeline", o.db);
    const h = c.securityLevel;
    let d;
    "sandbox" === h && (d = i("#i" + r));
    const u = i(
      "sandbox" === h ? d.nodes()[0].contentDocument.body : "body",
    ).select("#" + r);
    u.append("g");
    const p = o.db.getTasks(),
      y = o.db.getCommonDb().getDiagramTitle();
    (n.debug("task", p), U.initGraphics(u));
    const g = o.db.getSections();
    n.debug("sections", g);
    let f = 0,
      m = 0,
      x = 0,
    ...
    g.forEach(function (t) {
      const e = {
        ...
        i = U.getVirtualNodeHeight(u, e, c);
      (n.debug("sectionHeight before draw", i), (f = Math.max(f, i + 20)));
    });
    let S = 0,
      $ = 0;
    n.debug("tasks.length", p.length);
    for (const [e, i] of p.entries()) {
      const t = {
          number: e,
          descr: i,
          section: i.section,
        ...
        s = U.getVirtualNodeHeight(u, t, c);
      (n.debug("taskHeight before draw", s),
        (m = Math.max(m, s + 20)),
        (S = Math.max(S, i.events.length)));
      let r = 0;
      for (const e of i.events) {
        ...
        r += U.getVirtualNodeHeight(u, t, c);
      }
      (i.events.length > 0 && (r += 10 * (i.events.length - 1)),
        ($ = Math.max($, r)));
    }
    (n.debug("maxSectionHeight before draw", f),
      n.debug("maxTaskHeight before draw", m),
      g && g.length > 0
        ? g.forEach((t) => {
    ...
    (u
      ...
      s(void 0, u, c.timeline?.padding ?? 50, c.timeline?.useMaxWidth ?? !1));
  }, "draw"),
  Z = t(function (t, e, i, s, r, a, o, c, l, h, d) {
    for (const u of e) {
      const e = {
        descr: u.task,
        section: i,
      ...
      ((s += 200), d && !o.timeline?.disableMulticolor && i++);
    }
    r -= 10;
  }, "drawTasks"),
  X = t(function (t, e, i, s, r, a) {
    let o = 0;
    const c = r;
    r += 100;
    for (const l of e) {
    ...
    for (let n = 0; n < t.THEME_COLOR_LIMIT; n++)
      ((t["lineColor" + n] = t["lineColor" + n] || t["cScaleInv" + n]),
        r(t["lineColor" + n])
          ...
          : (t["lineColor" + n] = o(t["lineColor" + n], 20)));
    for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) {
      const i = "" + (17 - 3 * n);
