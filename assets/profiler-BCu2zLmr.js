...
function h(t, e, n) {
  ...
  const a = t.longTasks.map((t) => t.id).filter((t) => void 0 !== t);
  return (a.length && (s.long_task = { id: a }), s);
}
function b(t, e, n) {
  const s = (function (t, e, n) {
    const s = r(e),
      a = h(t, e.applicationId, n),
      i = (function (t) {
        const e = t.concat([
          "language:javascript",
          "runtime:chrome",
...
function k(r, o, w, h, k, I, S, M = y) {
  ...
  let C;
  const E = [];
  let T = { state: "stopped", stateReason: "initializing" };
  function D() {
  ...
  async function P(t) {
    (await (async function (t) {
      if ("running" !== T.state) return;
      (await B(), (T = { state: "stopped", stateReason: t }));
    })(t),
      E.forEach((t) => t()),
    ...
    try {
      n = new t({
        ...
        maxBufferSize: Math.round(
          (1.5 * M.collectIntervalMs) / M.sampleIntervalMs,
        ),
      });
    } catch (s) {
  ...
  async function x(t) {
    if ("running" !== t.state) return;
    (d(t.timeoutId), t.profiler.removeEventListener("samplebufferfull", O));
    const { startClocks: e, views: n } = t;
    await t.profiler
      .stop()
      .then((t) => {
        const s = p(),
          o = k.findLongTasks(e.relative),
          a = f(e.timeStamp, s.timeStamp) < M.minProfileDurationMs,
          i =
            (function (t) {
              let e = 0;
  ...
  async function B() {
    "running" === T.state && (T.cleanupTasks.forEach((t) => t()), await x(T));
  }
  function N(t) {
    "running" === T.state && t && T.views.push(t);
  }
  function O() {
    _();
  }
  function R() {
    "hidden" === document.visibilityState && "running" === T.state
      ? (async function () {
          "running" === T.state && (await B(), (T = { state: "paused" }));
        })().catch(a)
      : "visible" === document.visibilityState && "paused" === T.state && _();
  }
  function z() {
    _();
  }
  return (
    ...
    o.subscribe(10, () => {
      "stopped" === T.state && "session-expired" === T.stateReason && D();
    }),
    {
      start: D,
      stop: async function () {
