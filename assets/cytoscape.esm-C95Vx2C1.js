...
var Ct,
      ...
      if (E)
        for (var M = [], R = 0; R < g; R++) {
          var I = c[R],
            ...
            V = y(L).dist;
          if (O + z < V || (!a && V + z < O)) {
            if ((p || (rt(), (p = !0)), !1 === e.findNegativeWeightCycles))
              break;
            var F = [];
  ...
  ln = function (e, t) {
    return on(e, t.x1, t.y1) && on(e, t.x2, t.y2);
  },
  un =
...
var dn = function (e, t, n, r, a, i, o) {
    ...
    if (f) {
      var v = r - h - o;
      if (
        (s = kn(e, t, n, r, n - d + c - o, v, n + d - c + o, v, !1)).length > 0
      )
        return s;
    }
    if (p) {
      var g = n + d + o;
      if (
        (s = kn(e, t, n, r, g, r - h + c - o, g, r + h - c + o, !1)).length > 0
      )
        return s;
    }
    if (f) {
      var y = r + h + o;
      if (
        (s = kn(e, t, n, r, n - d + c - o, y, n + d - c + o, y, !1)).length > 0
      )
        return s;
    }
    if (p) {
      var m = n - d - o;
      if (
        (s = kn(e, t, n, r, m, r - h + c - o, m, r + h - c + o, !1)).length > 0
      )
        return s;
    }
    var b = n - d + c,
      x = r - h + c;
    if ((l = wn(e, t, n, r, b, x, c + o)).length > 0 && l[0] <= b && l[1] <= x)
      return [l[0], l[1]];
    var w = n + d - c,
      E = r - h + c;
    if ((l = wn(e, t, n, r, w, E, c + o)).length > 0 && l[0] >= w && l[1] <= E)
      return [l[0], l[1]];
    var k = n + d - c,
      T = r + h - c;
    if ((l = wn(e, t, n, r, k, T, c + o)).length > 0 && l[0] >= k && l[1] >= T)
      return [l[0], l[1]];
    var C = n - d + c,
      P = r + h - c;
    return (l = wn(e, t, n, r, C, P, c + o)).length > 0 &&
      l[0] <= C &&
      l[1] >= P
      ? [l[0], l[1]]
      : [];
  },
  hn = function (e, t, n, r, a, i, o) {
    var s = o,
      l = Math.min(n, a),
      u = Math.max(n, a),
      c = Math.min(r, i),
    ...
    for (var b = 0; b < u.length / 2; b++)
      ((c = u[2 * b]),
        ...
        b < u.length / 2 - 1
          ...
          : ((h = u[0]), (f = u[1])),
        0 !== (l = kn(e, t, r, a, c, d, h, f)).length && p.push(l[0], l[1]));
    return p;
  },
  Pn = function (e, t, n) {
...
((zn.dc = zn.degreeCentrality),
  (zn.dcn = zn.degreeCentralityNormalised = zn.degreeCentralityNormalized));
var On = lt({
    harmonic: !0,
    weight: function () {
      return 1;
...
((Vn.cc = Vn.closenessCentrality),
  (Vn.ccn = Vn.closenessCentralityNormalised =
    Vn.closenessCentralityNormalized));
var Fn = lt({ weight: null, directed: !1 }),
  Xn = {
...
var jn = lt({
  ...
  Un = function (e, t, n) {
    for (var r = e.slice(0), a = 1; a < n; a++) e = Wn(e, r, t);
    return e;
  },
  Hn = function (e, t, n) {
  ...
  Zn = function (e) {
    ...
    for (var y = !0, m = 0; y && m < a.maxIterations; )
      ((y = !1),
        (s = Un(c, l, a.expandFactor)),
        (c = Hn(s, l, a.inflateFactor)),
        Kn(c, s, u, 4) || (y = !0),
        m++);
    ...
    return (
      (b = (function (e) {
        for (var t = 0; t < e.length; t++)
          for (var n = 0; n < e.length; n++)
            t != n && Gn(e[t], e[n]) && e.splice(n, 1);
        return e;
      })(b)),
      b
    );
  },
  $n = { markovClustering: Zn, mcl: Zn },
  Qn = function (e) {
    return e;
  },
  Jn = function (e, t) {
  ...
  rr = function (e, t, n) {
    return Math.max(e, Jn(t, n));
  },
  ar = function (e, t, n, r, a) {
    for (
      var i =
          arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : Qn,
        o = r,
        s = 0;
      s < e;
      s++
  ...
  ir = {
    euclidean: function (e, t, n) {
      return e >= 2 ? ar(e, t, n, 0, tr, nr) : ar(e, t, n, 0, er);
    },
    squaredEuclidean: function (e, t, n) {
      return ar(e, t, n, 0, tr);
    },
    manhattan: function (e, t, n) {
      return ar(e, t, n, 0, er);
    },
    max: function (e, t, n) {
      return ar(e, t, n, -1 / 0, rr);
    },
  };
function or(e, t, n, r, a, i) {
  var o;
  return (
    (o = U(e) ? e : ir[e] || ir.euclidean),
    0 === t && U(e) ? o(a, i) : o(t, n, r, a, i)
  );
}
((ir["squared-euclidean"] = ir.squaredEuclidean),
  (ir.squaredeuclidean = ir.squaredEuclidean));
var sr = lt({
    k: 2,
    m: 2,
  ...
  gr = function (e, t) {
    ...
    if (e.length < 50)
      for (var r = 0; r < t; r++) {
        for (var a = e[Math.floor(Math.random() * e.length)]; vr(a, n, r); )
  ...
  yr = function (e, t, n) {
    for (var r = 0, a = 0; a < t.length; a++)
      r += ur("manhattan", t[a], e, n, "kMedoids");
    return r;
  },
  ...
  br = function (e, t, n, r, a) {
    ...
    for (var o, s, l, u = 2 / (a.m - 1), c = 0; c < n.length; c++)
      for (var d = 0; d < r.length; d++) {
        o = 0;
        for (var h = 0; h < n.length; h++)
          ((s = ur(a.distance, r[d], n[c], a.attributes, "cmeans")),
            (l = ur(a.distance, r[d], n[h], a.attributes, "cmeans")),
            (o += Math.pow(s / l, u)));
        e[d][c] = 1 / o;
      }
  },
  xr = function (e) {
    ...
    for (var y = !0, m = 0; y && m < l.maxIterations; )
      ((y = !1),
        mr(n, s, r, i, l),
        br(r, a, n, s, l),
        pr(r, a, l.sensitivityThreshold) || (y = !0),
        m++);
    return (
      (t = (function (e, t, n, r) {
    ...
    kMeans: function (e) {
      ...
      i.testMode
        ? "number" == typeof i.testCentroids
          ? (i.testCentroids, (t = cr(r, i.k, i.attributes)))
          : (t =
              "object" === l(i.testCentroids)
                ? i.testCentroids
                : cr(r, i.k, i.attributes))
        : (t = cr(r, i.k, i.attributes));
      for (var u = !0, c = 0; u && c < i.maxIterations; ) {
        for (var d = 0; d < r.length; d++)
          s[(a = r[d]).id()] = dr(a, t, i.distance, i.attributes, "kMeans");
        u = !1;
        for (var h = 0; h < i.k; h++) {
          var f = hr(h, r, s);
          if (0 !== f.length) {
            for (
              ...
              ((g[m] = y[m] / f.length),
                fr(g[m], v[m], i.sensitivityThreshold) || (u = !0));
            }
    ...
    kMedoids: function (e) {
      ...
      for (var d = !0, h = 0; d && h < o.maxIterations; ) {
        for (var f = 0; f < a.length; f++)
          u[(i = a[f]).id()] = dr(i, t, o.distance, o.attributes, "kMedoids");
        d = !1;
        for (var p = 0; p < t.length; p++) {
          var v = hr(p, a, u);
          if (0 !== v.length) {
            c[p] = yr(t[p], v, o.attributes);
            for (var g = 0; g < v.length; g++)
              (n = yr(v[g], v, o.attributes)) < c[p] &&
                ((c[p] = n), (t[p] = v[g]), (d = !0));
            s[p] = r.collection(v);
          }
        }
      ...
      (p.key === y.key
        ...
        : "min" === a.linkage
          ...
          : "max" === a.linkage
            ...
            : (i =
                "mean" === a.linkage
                  ? (n[p.key][y.key] * p.size + n[v.key][y.key] * v.size) /
                    (p.size + v.size)
                  : "dendrogram" === a.mode
                    ? u(y.value, p.value)
  ...
  Cr = function (e, t, n) {
    e &&
      (e.value
        ? t.push(e.value)
        : (e.left && Cr(e.left, t), e.right && Cr(e.right, t)));
  },
  Pr = function (e, t) {
    if (!e) return "";
    if (e.left && e.right) {
  ...
  Sr = function (e, t, n) {
    ...
    return 0 === t
      ...
      : 1 === t
        ...
        : e.value
          ? [n.collection(e.value)]
          : (e.left && (r = Sr(e.left, t - 1, n)),
            e.right && (a = Sr(e.right, t - 1, n)),
            r.concat(a));
  },
  Br = function (e) {
    for (
    ...
    for (var v, g = Tr(o, u, s, l, r); g; ) g = Tr(o, u, s, l, r);
    return (
      "dendrogram" === r.mode
        ? ((v = Sr(o[0], r.dendrogramDepth, t)), r.addDendrogram && Pr(o[0], t))
  ...
  Dr = { hierarchicalClustering: Br, hca: Br },
  _r = lt({
    distance: "euclidean",
    preference: "median",
    damping: 0.8,
  ...
  Ir = function (e) {
    ...
    for (var f = 0; f < t; f++)
      for (var p = 0; p < t; p++)
        f !== p && (r[f * t + p] = Ar(u.distance, l[f], l[p], u.attributes));
    a = Mr(r, u.preference);
    ...
    for (
      var j = (function (e, t, n) {
        ...
        Y = (function (e, t, n) {
          for (var r = Rr(e, t, n), a = 0; a < n.length; a++) {
  ...
  Nr = { affinityPropagation: Ir, ap: Ir },
  Lr = lt({ root: void 0, directed: !1 }),
  zr = function () {
    var e = this,
      t = {},
      n = 0,
...
[
  ...
  {
    hopcroftTarjanBiconnected: zr,
    htbc: zr,
    htb: zr,
    hopcroftTarjanBiconnectedComponents: zr,
  },
  {
    tarjanStronglyConnected: Or,
    tsc: Or,
    tscc: Or,
    tarjanStronglyConnectedComponents: Or,
  },
].forEach(function (e) {
  ge(Vr, e);
});
...
Fr.prototype = {
  fulfill: function (e) {
    return Xr(this, 1, "fulfillValue", e);
  },
  reject: function (e) {
    return Xr(this, 2, "rejectReason", e);
  },
  then: function (e, t) {
    var n = this,
      r = new Fr();
    return (
      n.onFulfilled.push(qr(e, r, "fulfill")),
      n.onRejected.push(qr(t, r, "reject")),
      jr(n),
      r.proxy
    );
  },
...
var Xr = function (e, t, n, r) {
    return (0 === e.state && ((e.state = t), (e[n] = r), jr(e)), e);
  },
  jr = function (e) {
    1 === e.state
      ? Yr(e, "onFulfilled", e.fulfillValue)
      : 2 === e.state && Yr(e, "onRejected", e.rejectReason);
  },
  Yr = function (e, t, n) {
    if (0 !== e[t].length) {
      var r = e[t];
...
((Fr.all = function (e) {
  ...
  (Fr.resolve = function (e) {
    return new Fr(function (t, n) {
      t(e);
    });
  }),
  (Fr.reject = function (e) {
    return new Fr(function (t, n) {
      n(e);
    });
  }));
var Ur = "undefined" != typeof Promise ? Promise : Fr,
  Hr = function (e, t, n) {
    var r = ee(e),
      a = !r,
...
(ge(Kr, {
  ...
  (Kr.complete = Kr.completed),
  (Kr.run = Kr.play),
  (Kr.running = Kr.playing));
var Gr,
  Zr,
  $r,
  Qr,
  ...
  Si = {
    ...
    animation: function () {
      return function (e, t) {
        ...
        var l = i.style();
        if (((e = ge({}, e, t)), 0 === Object.keys(e).length))
          return new Hr(a[0], e);
...
var go = {
    ...
    animated: vo.animated(),
    clearQueue: vo.clearQueue(),
    delay: vo.delay(),
    delayAnimation: vo.delayAnimation(),
    stop: vo.stop(),
  },
  yo = {
    classes: function (e) {
      ...
      H(e) || (e = (e || "").match(/\S+/g) || []);
      for (var r = [], a = new vt(e), i = 0; i < t.length; i++) {
        for (
...
yo.className = yo.classNames = yo.classes;
var mo = {
  metaChar:
    "[\\!\\\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\]\\^\\`\\{\\|\\}\\~]",
  comparatorOp: "=|\\!=|>|>=|<|<=|\\$=|\\^=|\\*=",
...
((mo.variable = "(?:[\\w-.]|(?:\\\\" + mo.metaChar + "))+"),
  (mo.className = "(?:[\\w-]|(?:\\\\" + mo.metaChar + "))+"),
  (mo.value = mo.string + "|" + mo.number),
  (mo.id = mo.variable),
  (function () {
    var e, t, n;
    for (e = mo.comparatorOp.split("|"), n = 0; n < e.length; n++)
      ((t = e[n]), (mo.comparatorOp += "|@" + t));
    for (e = mo.comparatorOp.split("|"), n = 0; n < e.length; n++)
      (t = e[n]).indexOf("!") >= 0 ||
        ("=" !== t && (mo.comparatorOp += "|\\!" + t));
  })());
var bo = 0,
  ...
  Xo = (function () {
    for (var e, t = {}, n = 0; n < Fo.length; n++)
      t[(e = Fo[n]).selector] = e.matches;
    return t;
  })(),
  jo =
    "(" +
  ...
  Wo = [
    ...
    },
    {
      ...
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: So, value: Yo(r) });
      },
    },
    {
      name: "className",
      ...
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: Bo, value: Yo(r) });
      },
    },
    {
      name: "dataExists",
      query: !0,
      regex: "\\[\\s*(" + mo.variable + ")\\s*\\]",
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: ko, field: Yo(r) });
      },
    },
    {
      name: "dataCompare",
      ...
      populate: function (e, t, n) {
        var r = i(n, 3),
          ...
          s = r[2];
        ((s =
          null != new RegExp("^" + mo.string + "$").exec(s)
            ? s.substring(1, s.length - 1)
            : parseFloat(s)),
          t.checks.push({ type: Eo, field: Yo(a), operator: o, value: s }));
      },
    },
    {
      name: "dataBool",
      query: !0,
      regex: "\\[\\s*(" + mo.boolOp + ")\\s*(" + mo.variable + ")\\s*\\]",
      populate: function (e, t, n) {
        var r = i(n, 2),
          a = r[0],
          o = r[1];
        t.checks.push({ type: To, field: Yo(o), operator: a });
      },
    },
    {
      name: "metaCompare",
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = { checks: [] };
          return (
            n.checks.push({ type: _o, source: r, target: a }),
            qo(e, 0, n),
            e.edgeCount++,
            a
          );
        ...
        var i = { checks: [] },
          ...
          s = { checks: [] };
        return (
          i.checks.push({ type: Ao, source: o, target: s }),
          qo(e, 0, i),
          e.edgeCount++,
          s
        );
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = { checks: [] };
          return (
            n.checks.push({ type: Do, nodes: [r, a] }),
            qo(e, 0, n),
            e.edgeCount++,
            a
          );
        ...
        var i = { checks: [] },
          ...
          s = { checks: [] };
        return (
          i.checks.push({ type: Ro, node: o, neighbor: s }),
          qo(e, 0, i),
          s
        );
      },
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = e[e.length - 1];
          return (
            n.checks.push({ type: Io, parent: a, child: r }),
            qo(e, 0, n),
            e.compoundCount++,
            r
          );
        ...
        if (e.currentSubject === t) {
          var i = { checks: [] },
            ...
            c = { checks: [] };
          return (
            i.checks.push({ type: Oo, left: o, right: s, subject: l }),
            (l.checks = t.checks),
            (t.checks = [{ type: Vo }]),
            c.checks.push({ type: Vo }),
            s.checks.push({ type: Lo, parent: c, child: u }),
            qo(e, 0, i),
            (e.currentSubject = l),
            e.compoundCount++,
            u
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = e[e.length - 1];
          return (
            n.checks.push({ type: No, ancestor: a, descendant: r }),
            qo(e, 0, n),
            e.compoundCount++,
            r
          );
        ...
        if (e.currentSubject === t) {
          ...
          return (
            ...
            (t.checks = [{ type: Vo }]),
            c.checks.push({ type: Vo }),
            s.checks.push({ type: zo, ancestor: c, descendant: u }),
            qo(e, 0, i),
            (e.currentSubject = l),
            e.compoundCount++,
            u
        ...
        var d = { checks: [] },
          h = { checks: [] },
          f = [{ type: zo, ancestor: d, descendant: h }];
        return ((d.checks = t.checks), (t.checks = f), e.compoundCount++, h);
      },
    },
    {
...
var Uo = function (e) {
    for (var t, n, r, a = 0; a < Wo.length; a++) {
      var i = Wo[a],
        o = i.name,
  ...
  Ho = {
    parse: function (e) {
      ...
      for (var l = 0; l < t.length; l++) {
        var u = t[l];
        if (u.compoundCount > 0 && u.edgeCount > 0) return (rt(), !1);
        if (u.edgeCount > 1) return (rt(), !1);
        1 === u.edgeCount && rt();
      }
      return !0;
    },
...
((Zo[bo] = function (e, t) {
  ...
  (Zo[ko] = function (e, t) {
    var n = e.field;
    return (e.operator, void 0 !== Go(t, n));
  }),
  (Zo[Do] = function (e, t) {
    var n = e.nodes[0],
      r = e.nodes[1],
      a = t.source(),
      i = t.target();
    return ($o(n, a) && $o(r, i)) || ($o(r, a) && $o(n, i));
  }),
  (Zo[Ro] = function (e, t) {
    return (
      $o(e.node, t) &&
      t.neighborhood().some(function (t) {
        return t.isNode() && $o(e.neighbor, t);
      })
    );
  }),
  (Zo[_o] = function (e, t) {
    return $o(e.source, t.source()) && $o(e.target, t.target());
  }),
  (Zo[Ao] = function (e, t) {
    return (
      $o(e.source, t) &&
      t.outgoers().some(function (t) {
        return t.isNode() && $o(e.target, t);
      })
    );
  }),
  (Zo[Mo] = function (e, t) {
    return (
      ...
      t.incomers().some(function (t) {
        return t.isNode() && $o(e.source, t);
      })
    );
  }),
  (Zo[Io] = function (e, t) {
    return $o(e.child, t) && $o(e.parent, t.parent());
  }),
  (Zo[Lo] = function (e, t) {
    return (
      $o(e.parent, t) &&
  ...
  (Zo[zo] = function (e, t) {
    return (
      ...
      t.descendants().some(function (t) {
        return $o(e.descendant, t);
      })
    );
  }),
  (Zo[Oo] = function (e, t) {
    return $o(e.subject, t) && $o(e.left, t) && $o(e.right, t);
  }),
  (Zo[Vo] = function () {
    return !0;
  }),
...
var Qo = function (e) {
    ((this.inputText = e),
      ...
      null == e ||
        (W(e) && e.match(/^\s*$/)) ||
        ($(e)
          ? this.addQuery({ checks: [{ type: xo, value: e.collection() }] })
          : U(e)
            ? this.addQuery({ checks: [{ type: wo, value: e }] })
            : W(e)
...
([
  ...
  (Jo.sameText = function (e) {
    return !this.invalid && !e.invalid && this.text() === e.text();
  }),
  (Jo.addQuery = function (e) {
    this[this.length++] = e;
  }),
  (Jo.selector = Jo.toString));
var es = {
  allAre: function (e) {
    var t = new Qo(e);
...
((es.allAreNeighbours = es.allAreNeighbors),
  (es.has = es.contains),
  (es.equal = es.equals = es.same));
var ts,
  ns,
  rs = function (e, t) {
...
function is(e, t, n, r) {
  for (
    var a = [], i = new vt(), o = e.cy().hasCompoundNodes(), s = 0;
    s < e.length;
    s++
  ) {
    var l = e[s];
...
((as.forEachDown = function (e) {
  ...
  (as.forEachUpAndDown = function (e) {
    return is(
      this,
      e,
      !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
  ...
  ((ts = ns =
    {
      ...
      removeRscratch: vo.removeData({ field: "rscratch", triggerEvent: !1 }),
      id: function () {
        var e = this[0];
        if (e) return e._private.data.id;
      },
    }).attr = ts.data),
  (ts.removeAttr = ts.removeData));
var us,
  cs,
  ds = ns,
  hs = {};
...
(ge(hs, {
  degree: fs(function (e, t) {
    return t.source().same(t.target()) ? 2 : 1;
  }),
  indegree: fs(function (e, t) {
    return t.target().same(e) ? 1 : 0;
  }),
  outdegree: fs(function (e, t) {
    return t.source().same(e) ? 1 : 0;
  }),
}),
  ge(hs, {
    minDegree: ps("degree", function (e, t) {
      return e < t;
    }),
    maxDegree: ps("degree", function (e, t) {
      return e > t;
    }),
    minIndegree: ps("indegree", function (e, t) {
      return e < t;
    }),
    maxIndegree: ps("indegree", function (e, t) {
      return e > t;
    }),
    minOutdegree: ps("outdegree", function (e, t) {
      return e < t;
    }),
    maxOutdegree: ps("outdegree", function (e, t) {
      return e > t;
    }),
  }),
  ge(hs, {
...
((us = cs =
  ...
  (us.modelPosition = us.point = us.position),
  (us.modelPositions = us.points = us.positions),
  (us.renderedPoint = us.renderedPosition),
  (us.relativePoint = us.relativePosition));
var ys,
  ms,
  bs = cs;
((ys = ms = {}),
  (ms.renderedBoundingBox = function (e) {
  ...
  (ms.dirtyCompoundBoundsCache = function () {
  ...
  (ms.updateCompoundBounds = function () {
    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
      t = this.cy();
...
var xs = function (e) {
  ...
  Es = function (e, t) {
    return null == t ? e : ws(e, t.x1, t.y1, t.x2, t.y2);
  },
  ks = function (e, t, n) {
    return dt(e, t, n);
  },
  ...
  Cs = function (e, t, n) {
    if (!t.cy().headless()) {
      ...
      if (t.pstyle(r + "label").strValue) {
        ...
        if (I || N) {
          var L = I ? ks(a.rstyle, "labelAngle", n) : b.pfValue,
            z = Math.cos(L),
            O = Math.sin(L),
            V = (o + s) / 2,
            F = (l + u) / 2;
  ...
  Ps = function (e, t) {
    if (!t.cy().headless()) {
      ...
      Ss(e, t, n, r, "outside", r / 2);
    }
  },
  Ss = function (e, t, n, r, a, i) {
    if (!(0 === n || r <= 0 || "inside" === a)) {
      var o = t.cy(),
    ...
    if (b) {
      ...
      if ((c && (k = e.pstyle("width").pfValue / 2), p && t.includeNodes)) {
        ...
        var C = e.outerWidth() / 2,
          P = e.outerHeight() / 2;
        (ws(h, (n = o - C), (a = s - P), (r = o + C), (i = s + P)),
          c && Ps(h, e),
          c && t.includeOutlines && !d && Ps(h, e),
          c &&
            (function (e, t) {
              if (!t.cy().headless()) {
      ...
      if (
        ...
        if ("yes" === e.pstyle("ghost").value) {
          ...
          ws(h, h.x1 + O, h.y1 + V, h.x2 + O, h.y2 + V);
        }
      ...
      (rn(F, h),
        ...
        c &&
          ...
          (a = h.y1),
          (i = h.y2),
          ws(h, n - E, a - E, r + E, i + E)));
      var X = (f.overlayBounds = f.overlayBounds || {});
      (rn(X, h), nn(X, y), tn(X, 1));
      ...
      (null != j.all
        ...
        c &&
          t.includeLabels &&
          (t.includeMainLabels && Cs(h, e, null),
          v &&
            (t.includeSourceLabels && Cs(h, e, "source"),
            t.includeTargetLabels && Cs(h, e, "target"))));
    }
    return (
      (h.x1 = xs(h.x1)),
      (h.y1 = xs(h.y1)),
  ...
  As = function (e, t) {
    ...
    if (
      (null == r.bbCache
        ? ((n = Bs(e, Ms)), (r.bbCache = n), (r.bbCachePosKey = _s(e)))
        : (n = r.bbCache),
      !i)
    ) {
      var o = e.isNode();
      ((n = Qt()),
        ((t.includeNodes && o) || (t.includeEdges && !o)) &&
          (t.includeOverlays ? Es(n, r.overlayBounds) : Es(n, r.bodyBounds)),
        t.includeLabels &&
          (t.includeMainLabels &&
          (!a || (t.includeSourceLabels && t.includeTargetLabels))
            ? Es(n, r.labelBounds.all)
            : (t.includeMainLabels && Es(n, r.labelBounds.mainRot),
              t.includeSourceLabels && Es(n, r.labelBounds.sourceRot),
              t.includeTargetLabels && Es(n, r.labelBounds.targetRot))),
        (n.w = n.x2 - n.x1),
        (n.h = n.y2 - n.y1));
    }
    return n;
  ...
  Rs = Ds(Ms),
  Is = lt(Ms);
((ms.boundingBox = function (e) {
  var t,
    n = void 0 === e || void 0 === e.useCache || !0 === e.useCache,
    r = ae(
      function (e) {
        var t = e._private;
        return null == t.bbCache || t.styleDirty || t.bbCachePosKey !== _s(e);
      },
      function (e) {
        return e.id();
      },
  ...
  if (n && 1 === this.length && !r(this[0]))
    ((e = void 0 === e ? Ms : Is(e)), (t = As(this[0], e)));
  else {
    t = Qt();
    var a = Is((e = e || Ms)),
      i = this,
    ...
    for (var s = 0; s < i.length; s++) {
      var l = i[s];
      (r(l) && l.dirtyBoundingBoxCache(), Es(t, As(l, a)));
    }
  }
  return (
    (t.x1 = xs(t.x1)),
  ...
  (ms.dirtyBoundingBoxCache = function () {
  ...
  (ys.boundingbox = ys.bb = ys.boundingBox),
  (ys.renderedBoundingbox = ys.renderedBoundingBox));
var Ns,
  Ls,
  zs = ms;
Ns = Ls = {};
var Os = function (e) {
  ((e.uppercaseName = le(e.name)),
    ...
    (Ns["outer" + e.uppercaseName] = function () {
      var t = this[0],
    ...
    (Ns["rendered" + e.uppercaseName] = function () {
      var t = this[0];
      if (t) return t[e.name]() * this.cy().zoom();
    }),
    (Ns["rendered" + e.uppercaseOuterName] = function () {
      var t = this[0];
...
(Os({ name: "width" }),
  ...
  (Ls.paddedHeight = function () {
    var e = this[0];
    return e.height() + 2 * e.padding();
  }),
  (Ls.paddedWidth = function () {
    var e = this[0];
...
var Vs = Ls,
  ...
  Xs = Object.keys(Fs).reduce(function (e, t) {
    var n = Fs[t],
      r = (function (e) {
...
Ys.prototype = {
  ...
  recycle: function (e, t) {
    if (
      ...
      null != e && e.preventDefault
        ? ((this.type = e.type),
          (this.isDefaultPrevented = e.defaultPrevented ? Ws : qs))
        : null != e && e.type
          ? (t = e)
          : (this.type = e),
      null != t &&
  ...
  stopImmediatePropagation: function () {
    ((this.isImmediatePropagationStopped = Ws), this.stopPropagation());
  },
  isDefaultPrevented: qs,
  isPropagationStopped: qs,
  isImmediatePropagationStopped: qs,
};
var Us = /^([^.]+)(\.(?:[^.]+))?$/,
  Hs = {
...
var $s = Zs.prototype,
  ...
  Js = function (e, t) {
    return (e.addEventFields(e.context, t), new Ys(t.type, t));
  },
  el = function (e, t, n) {
    if ("event" !== q(n))
      if (K(n)) t(e, Js(e, n));
        ...
        for (var r = H(n) ? n : n.split(/\s+/), a = 0; a < r.length; a++) {
          ...
          if (!ne(i)) {
            ...
            if (o) {
              var s = o[1],
                l = o[2] ? o[2] : null;
              t(e, Js(e, { type: s, namespace: l, target: e.context }));
            }
          }
        }
    else t(e, n);
  ...
  rl = {
    createEmitter: function () {
      for (var e = 0; e < this.length; e++) {
        var t = this[e],
          n = t._private;
        n.emitter || (n.emitter = new Zs(tl, t));
      }
      return this;
    },
    emitter: function () {
    ...
    on: function (e, t, n) {
      for (var r = nl(t), a = 0; a < this.length; a++) {
...
var al = {
    ...
    filter: function (e, t) {
      ...
      if (W(e) || $(e)) return new Qo(e).filter(this);
      if (U(e)) {
  ...
  il = al;
((il.u = il["|"] = il["+"] = il.union = il.or = il.add),
  (il["\\"] =
    il["!"] =
    il["-"] =
    il.difference =
    il.relativeComplement =
    il.subtract =
      il.not),
  (il.n = il["&"] = il["."] = il.and = il.intersection = il.intersect),
  (il["^"] =
    il["(+)"] =
    il["(-)"] =
    il.symmetricDifference =
    il.symdiff =
      il.xor),
  (il.fnFilter = il.filterFn = il.stdFilter = il.filter),
  (il.complement = il.abscomp = il.absoluteComplement));
var ol = function (e, t) {
...
var ll;
((ll = "undefined"),
  ("undefined" == typeof Symbol ? "undefined" : l(Symbol)) != ll &&
    l(Symbol.iterator) != ll &&
    (sl[Symbol.iterator] = function () {
      var e = this,
...
var ul = lt({ nodeDimensionsIncludeLabels: !1 }),
  cl = {
...
var ml = hl("eleInteractive", function (e) {
    return (
  ...
  bl = hl("parentInteractive", function (e) {
    return "visible" === e.pstyle("visibility").value && yl(e);
  });
((pl.interactive = fl(
  "interactive",
  gl({ ok: ml, parentOk: bl, edgeOkViaNode: yl }),
)),
  (pl.noninteractive = function () {
    var e = this[0];
    if (e) return !e.interactive();
  }));
var xl = hl("eleVisible", function (e) {
    return (
      "visible" === e.pstyle("visibility").value &&
  ...
  wl = yl;
((pl.visible = fl("visible", gl({ ok: xl, edgeOkViaNode: wl }))),
  (pl.hidden = function () {
    var e = this[0];
...
(Tl({
  ...
  (El.deselect = El.unselect),
  (El.grabbed = function () {
    var e = this[0];
    if (e) return e._private.grabbed;
  }),
  Tl({ field: "active", on: "activate", off: "unactivate" }),
  Tl({ field: "pannable", on: "panify", off: "unpanify" }),
  (El.inactive = function () {
    var e = this[0];
...
((Cl.clearTraversalCache = function () {
  for (var e = 0; e < this.length; e++) this[e]._private.traversalCache = null;
}),
  ge(Cl, {
    roots: Pl({ noIncomingEdges: !0 }),
    leaves: Pl({ noOutgoingEdges: !0 }),
    outgoers: rs(Sl({ outgoing: !0 }), "outgoers"),
    successors: Bl({ outgoing: !0 }),
    incomers: rs(Sl({ incoming: !0 }), "incomers"),
    predecessors: Bl({}),
  }),
  ge(Cl, {
    neighborhood: rs(function (e) {
  ...
  (Cl.neighbourhood = Cl.neighborhood),
  (Cl.closedNeighbourhood = Cl.closedNeighborhood),
  (Cl.openNeighbourhood = Cl.openNeighborhood),
  ge(Cl, {
    source: rs(function (e) {
      var t,
        n = this[0];
      return (
  ...
  ge(Cl, {
    edgesWith: rs(_l(), "edgesWith"),
    edgesTo: rs(_l({ thisIsSrc: !0 }), "edgesTo"),
  }),
  ge(Cl, {
    connectedEdges: rs(function (e) {
      for (var t = [], n = 0; n < this.length; n++) {
        var r = this[n];
        if (r.isNode())
    ...
    parallelEdges: rs(Al(), "parallelEdges"),
    codirectedEdges: rs(Al({ codirected: !0 }), "codirectedEdges"),
  }),
  ge(Cl, {
...
var Ml = function (e, t) {
    ...
    if (void 0 !== e) {
      ...
      if (t) {
        if (t.length > 0 && K(t[0]) && !Q(t[0])) {
          i = !0;
          for (var o = [], s = new vt(), l = 0, u = t.length; l < u; l++) {
            var c = t[l];
            null == c.data && (c.data = {});
            var d = c.data;
  ...
  Rl = (gt.prototype = Ml.prototype = Object.create(Array.prototype));
((Rl.instanceString = function () {
  return "collection";
}),
  (Rl.spawn = function (e, t) {
    return new Ml(this.cy(), e, t);
  }),
  (Rl.spawnSelf = function () {
    return this.spawn(this);
  }),
  (Rl.cy = function () {
    return this._private.cy;
  }),
  (Rl.renderer = function () {
    return this._private.cy.renderer();
  }),
  (Rl.element = function () {
    return this[0];
  }),
  (Rl.collection = function () {
    return J(this) ? this : new Ml(this._private.cy, [this]);
  }),
  (Rl.unique = function () {
    return new Ml(this._private.cy, this, !0);
  }),
  (Rl.hasElementWithId = function (e) {
    return ((e = "" + e), this._private.map.has(e));
  }),
  (Rl.getElementById = function (e) {
    e = "" + e;
    var t = this._private.cy,
      n = this._private.map.get(e);
    return n ? n.ele : new Ml(t);
  }),
  (Rl.$id = Rl.getElementById),
  (Rl.poolIndex = function () {
    var e = this._private.cy._private.elements,
      t = this[0]._private.data.id;
    return e._private.map.get(t).index;
  }),
  (Rl.indexOf = function (e) {
    var t = e[0]._private.data.id;
    return this._private.map.get(t).index;
  }),
  (Rl.indexOfId = function (e) {
  ...
  (Rl.restore = function () {
    ...
    for (t = 0; t < e.length; t++) {
      ...
      if ((f.clearTraversalCache(), r || p.removed))
        if (void 0 === v.id) v.id = it();
        else if (G(v.id)) v.id = "" + v.id;
        else {
          if (ne(v.id) || !W(v.id)) {
            (tt("Can not create element with invalid string ID `" + v.id + "`"),
              h());
            continue;
          }
          if (i.hasElementWithId(v.id)) {
            (tt("Can not create second element with ID `" + v.id + "`"), h());
            continue;
          }
        }
      else;
      ...
      if (f.isEdge()) {
        for (
          ...
          (G(T) && (T = v[k] = "" + v[k]),
            null == T || "" === T
              ? (tt("Can not create edge `" + g + "` with unspecified " + k),
                (w = !0))
    ...
    for (var S = 0; S < s.length; S++) {
      ...
      if (null != _ || B._private.parent) {
        ...
        if (A.empty()) D.parent = void 0;
          ...
          (rt(), (D.parent = void 0), (B._private.parent = null));
        else {
    ...
    if (e.length > 0) {
      for (
        var I = e.length === a.length ? a : new Ml(i, e), N = 0;
        N < I.length;
        N++
      ) {
        var L = I[N];
...
/*! Bezier curve function generator. Copyright Gaetan Renaudeau. MIT License: http://en.wikipedia.org/wiki/MIT_License */ function Nl(
  e,
  t,
  n,
  r,
...
/*! Runge-Kutta spring physics function generator. Adapted from Framer.js, copyright Koen Bok. MIT License: http://en.wikipedia.org/wiki/MIT_License */ var Ll =
    (function () {
      function e(e) {
  ...
  Ol = {
    ...
    ease: zl(0.25, 0.1, 0.25, 1),
    "ease-in": zl(0.42, 0, 1, 1),
    "ease-out": zl(0, 0, 0.58, 1),
    "ease-in-out": zl(0.42, 0, 0.58, 1),
    "ease-in-sine": zl(0.47, 0, 0.745, 0.715),
    "ease-out-sine": zl(0.39, 0.575, 0.565, 1),
    "ease-in-out-sine": zl(0.445, 0.05, 0.55, 0.95),
    "ease-in-quad": zl(0.55, 0.085, 0.68, 0.53),
    "ease-out-quad": zl(0.25, 0.46, 0.45, 0.94),
    "ease-in-out-quad": zl(0.455, 0.03, 0.515, 0.955),
    "ease-in-cubic": zl(0.55, 0.055, 0.675, 0.19),
    "ease-out-cubic": zl(0.215, 0.61, 0.355, 1),
    "ease-in-out-cubic": zl(0.645, 0.045, 0.355, 1),
    "ease-in-quart": zl(0.895, 0.03, 0.685, 0.22),
    "ease-out-quart": zl(0.165, 0.84, 0.44, 1),
    "ease-in-out-quart": zl(0.77, 0, 0.175, 1),
    "ease-in-quint": zl(0.755, 0.05, 0.855, 0.06),
    "ease-out-quint": zl(0.23, 1, 0.32, 1),
    "ease-in-out-quint": zl(0.86, 0, 0.07, 1),
    "ease-in-expo": zl(0.95, 0.05, 0.795, 0.035),
    "ease-out-expo": zl(0.19, 1, 0.22, 1),
    "ease-in-out-expo": zl(1, 0, 0, 1),
    "ease-in-circ": zl(0.6, 0.04, 0.98, 0.335),
    "ease-out-circ": zl(0.075, 0.82, 0.165, 1),
    "ease-in-out-circ": zl(0.785, 0.135, 0.15, 0.86),
    spring: function (e, t, n) {
      if (0 === n) return Ol.linear;
      var r = Ll(e, t, n);
      return function (e, t, n) {
        return e + (t - e) * r(n);
      };
...
function Xl(e, t, n, r, a) {
  ...
  var o = Fl(e, a),
    s = Fl(t, a);
  if (G(o) && G(s)) return Vl(i, o, s, n, r);
  if (H(o) && H(s)) {
...
function jl(e, t, n, r) {
  var a = !r,
    ...
    u = (r ? e : e.cy()).style();
  if (!o.easingImpl)
    if (null == s) o.easingImpl = Ol.linear;
    else {
      var c, d, h;
      ...
      (W(c)
        ...
        h.length > 0
          ? ("spring" === d && h.push(o.duration),
            (o.easingImpl = Ol[d].apply(null, h)))
          : (o.easingImpl = Ol[d]));
    }
  var f,
    p = o.easingImpl;
  if (
    ...
    if (g && a && !e.locked()) {
      var y = {};
      (Yl(v.x, g.x) && (y.x = Xl(v.x, g.x, f, p)),
        Yl(v.y, g.y) && (y.y = Xl(v.y, g.y, f, p)),
        e.position(y));
    }
    var m = o.startPan,
      b = o.pan,
      ...
      w = null != b && r;
    w &&
      (Yl(m.x, b.x) && (x.x = Xl(m.x, b.x, f, p)),
      Yl(m.y, b.y) && (x.y = Xl(m.y, b.y, f, p)),
      e.emit("pan"));
    var E = o.startZoom,
      k = o.zoom,
      T = null != k && r;
    (T &&
      (Yl(E, k) && (i.zoom = $t(i.minZoom, Xl(E, k, f, p), i.maxZoom)),
      e.emit("zoom")),
      (w || T) && e.emit("viewport"));
    var C = o.style;
    if (C && C.length > 0 && a) {
      for (var P = 0; P < C.length; P++) {
        var S = C[P],
          ...
          D = S,
          _ = o.startStyle[B],
          A = Xl(_, D, f, p, u.properties[_.name]);
...
var Ul = {
  ...
  Gl = {
    createEmitter: function () {
      var e = this._private;
      return (e.emitter || (e.emitter = new Zs(Hl, this)), this);
    },
    emitter: function () {
      return this._private.emitter;
    },
    on: function (e, t, n) {
      return (this.emitter().on(e, Kl(t), n), this);
    },
    removeListener: function (e, t, n) {
      return (this.emitter().removeListener(e, Kl(t), n), this);
    },
    removeAllListeners: function () {
      return (this.emitter().removeAllListeners(), this);
    },
    one: function (e, t, n) {
      return (this.emitter().one(e, Kl(t), n), this);
    },
    once: function (e, t, n) {
      return (this.emitter().one(e, Kl(t), n), this);
    },
  ...
  collection: function (e, t) {
    return W(e)
      ...
      : $(e)
        ? e.collection()
        : H(e)
          ? (t || (t = {}), new Ml(this, e, t.unique, t.removed))
          : new Ml(this);
  },
  nodes: function (e) {
...
((nu.apply = function (e) {
  ...
  (nu.getPropertiesDiff = function (e, t) {
    var n = this,
      ...
      if (h || (d && f)) {
        ...
        for (var v = 0; v < p.length; v++) {
          for (var g = p[v], y = g.name, m = !1, b = l + 1; b < n.length; b++) {
            var x = n[b];
            if (t[b] === ru && (m = null != x.properties[g.name])) break;
          }
  ...
  (nu.getContextMeta = function (e) {
    for (
      ...
      var o = n[i];
      r += o.selector && o.selector.matches(e) ? ru : "f";
    }
    return (
  ...
  (nu.applyContextStyle = function (e, t, n) {
    for (
  ...
  (nu.updateStyleHints = function (e) {
    var t = e._private,
      n = this,
  ...
  (nu.applyParsedProperty = function (e, t) {
    var n,
      r = this,
      a = t,
      i = e._private.style,
    ...
    var v = function () {
      rt((e.id(), a.name, a.field, a.field, a.field));
    };
    switch (a.mapped) {
      case o.mapData:
        for (
        ...
        if (!G(m)) return (rt((a.field, e.id())), !1);
      ...
      case o.fn:
        ...
        if (((a.prevFnValue = N), null == N)) return (rt((a.name, e.id())), !1);
        if (!(n = this.parse(a.name, N, a.bypass, h)))
          return (rt((a.name, e.id())), !1);
        ((n.mapping = at(a)), (a = n));
        break;
      case void 0:
        break;
  ...
  (nu.updateTransitions = function (e, t) {
    var n = this,
      r = e._private,
  ...
  (nu.checkTrigger = function (e, t, n, r, a, i) {
    var o = this.properties[t],
      s = a(o);
    e.removed() || (null != s && s(n, r, e) && i(o));
  }),
  (nu.checkZOrderTrigger = function (e, t, n, r) {
    var a = this;
    this.checkTrigger(
      e,
      t,
  ...
  (nu.checkBoundsTrigger = function (e, t, n, r) {
    this.checkTrigger(
      e,
      t,
      n,
  ...
  (nu.checkConnectedEdgesBoundsTrigger = function (e, t, n, r) {
    this.checkTrigger(
      e,
      t,
      n,
  ...
  (nu.checkParallelEdgesBoundsTrigger = function (e, t, n, r) {
    this.checkTrigger(
      e,
      t,
      n,
  ...
  (nu.checkTriggers = function (e, t, n, r) {
    (e.dirtyStyleCache(),
    ...
    applyBypass: function (e, t, n, r) {
      ...
      for (var v = !1, g = 0; g < e.length; g++) {
        for (var y = e[g], m = {}, b = void 0, x = 0; x < a.length; x++) {
          ...
          ((v = this.applyParsedProperty(y, at(w)) || v),
...
ou.getPropertiesHash = ou.getNonDefaultPropertiesHash;
var su = {
      ...
      for (i = i.replace(/[/][*](\s|.)+?[*][/]/g, ""); ; ) {
        ...
        for (var h = []; ; ) {
          ...
          if (this.properties[p])
            a.parse(p, v) ? (h.push({ name: p, val: v }), s()) : (rt(), s());
          else (rt(), s());
        }
        if (d) {
          o();
...
(!(function () {
  ...
  for (var B = 1; B <= uu.pieBackgroundN; B++)
  ...
  var A = [],
    M = (uu.arrowPrefixes = ["source", "mid-source", "target", "mid-target"]);
  [
  ...
  var R = (uu.properties = [].concat(
    ...
    N = (uu.propertyGroupNames = {});
  (uu.propertyGroupKeys = Object.keys(I)).forEach(function (e) {
  ...
  uu.propertyNames = R.map(function (e) {
    return e.name;
  });
  ...
  (uu.getDefaultProperty = function (e) {
    return this.getDefaultProperties()[e];
  }),
  (uu.getDefaultProperties = function () {
    var e = this._private;
    ...
    for (
      var t = ge(
          ...
          [
            ...
            for (var n = 1; n <= uu.pieBackgroundN; n++) {
          ...
          [
            ...
            for (var n = 1; n <= uu.stripeBackgroundN; n++) {
              var r = t.name.replace("{{i}}", n),
                a = t.value;
              e[r] = a;
            }
          ...
          [
            ...
            return (
              uu.arrowPrefixes.forEach(function (n) {
                var r = n + "-" + t.name,
                  a = t.value;
                e[r] = a;
              }),
  ...
  (uu.addDefaultStylesheet = function () {
  ...
  if (!l || r || t.length < 7 || "a" !== t[1]);
    ...
    if (
      ...
      if (p.pfValue === v.pfValue || p.strValue === v.strValue)
        return (rt(p.strValue), this.parse(e, p.strValue));
      if (d.color) {
        var g = p.value,
          y = v.value;
        if (
...
((hu.instanceString = function () {
  ...
  (hu.resetToDefault = function () {
    return (this.clear(), this.addDefaultStylesheet(), this);
  }),
  (hu.core = function (e) {
    return this._private.coreStyle[e] || this.getDefaultProperty(e);
  }),
  (hu.selector = function (e) {
    var t = "core" === e ? null : new Qo(e),
      n = this.length++;
    return (
      (this[n] = {
        selector: t,
  ...
  (du.fromJson = function (e, t) {
    var n = new du(e);
    return (n.fromJson(t), n);
  }),
  (du.fromString = function (e, t) {
    return new du(e).fromString(t);
  }),
  [nu, au, iu, ou, su, lu, uu, cu].forEach(function (e) {
    ge(hu, e);
  }),
  (du.types = hu.types),
  (du.properties = hu.properties),
  (du.propertyGroups = hu.propertyGroups),
  (du.propertyGroupNames = hu.propertyGroupNames),
  (du.propertyGroupKeys = hu.propertyGroupKeys));
var fu = {
    style: function (e) {
    ...
    setStyle: function (e) {
      ...
      return (
        te(e)
          ...
          : H(e)
            ? (t.style = du.fromJson(this, e))
            : W(e)
              ? (t.style = du.fromString(this, e))
              : (t.style = du(this)),
        t.style
      );
    },
...
((pu.centre = pu.center),
  (pu.autolockNodes = pu.autolock),
  (pu.autoungrabifyNodes = pu.autoungrabify));
var vu = {
  data: vo.data({
    field: "data",
    bindingEvent: "data",
...
((vu.attr = vu.data), (vu.removeAttr = vu.removeData));
var gu = function (e) {
    var t = this,
      n = (e = ge({}, e)).container;
    n && !Z(n) && Z(n[0]) && (n = n[0]);
    ...
    t.initRenderer(u);
    !(function (e, t) {
      if (e.some(re)) return Ur.all(e).then(t);
      t(e);
...
(ge(yu, {
  ...
  (yu.$id = yu.getElementById),
  [Il, Ul, Gl, Zl, $l, Ql, eu, tu, fu, pu, vu].forEach(function (e) {
    ge(yu, e);
  }));
var mu = {
    fit: !0,
...
Eu.prototype.run = function () {
  ...
  var y = [],
    ...
    b = function (e, t) {
      null == y[t] && (y[t] = []);
      var n = y[t].length;
      (y[t].push(e), wu(e, { index: n, depth: t }));
    };
  i.bfs({
    roots: e,
    directed: t.directed,
  ...
  var k = function (e) {
      for (var t = y[e], n = 0; n < t.length; n++) {
        var r = t[n];
        null != r ? wu(r, { depth: e, index: n }) : (t.splice(n, 1), n--);
      }
    },
    T = function (e, n) {
      for (
  ...
  var L = {},
    z = function (e) {
      ...
      for (
        var t = xu(e).depth, n = e.neighborhood(), r = 0, i = 0, o = 0;
        o < n.length;
        o++
      ) {
        var s = n[o];
...
function Du(e) {
  ((this.options = ge({}, Bu, e)), (this.options.layout = this));
...
((Du.prototype.run = function () {
  ...
  ((n.stopped = !1),
    ...
    (Cu = !0 === e.debug));
  var r = _u(t, n, e);
  (Cu && undefined(r), e.randomize && Ru(r));
  var a = Ie(),
    i = function () {
      (Nu(r, t, e), !0 === e.fit && t.fit(e.padding));
    },
    o = function (t) {
      return (
  ...
  if (!0 === e.animate) {
    var c = function () {
      ...
      u ? (Ie() - a >= e.animationThreshold && i(), Re(c)) : (Ku(r, e), s());
    };
    c();
  } else {
    for (; u; ) ((u = o(l)), l++);
...
var _u = function (e, t, n) {
    ...
    for (u = 0; u < o.edgeSize; u++) {
      ...
      if (o.indexToGraph[B] != o.indexToGraph[D]) {
        for (
          var _ = Au(C.sourceId, C.targetId, o),
            A = o.graphSet[_],
            M = 0,
            R = o.layoutNodes[B];
          -1 === A.indexOf(R.id);
  ...
  Wu = function (e, t) {
    ...
    for (n = 0; n < e.nodeSize; n++) {
      if (!(0 < (a = e.layoutNodes[n]).children.length || a.isLocked)) {
        var r = Uu(a.offsetX, a.offsetY, e.temperature);
        ((a.positionX += r.x),
          (a.positionY += r.y),
          (a.offsetX = 0),
          (a.offsetY = 0),
...
var $u = { ready: function () {}, stop: function () {} };
function Qu(e) {
  this.options = ge({}, $u, e);
}
...
var rc = [
  { name: "breadthfirst", impl: Eu },
  { name: "circle", impl: Tu },
  { name: "concentric", impl: Su },
  { name: "cose", impl: Du },
  { name: "grid", impl: Zu },
  { name: "null", impl: Qu },
  { name: "preset", impl: ec },
      ...
      function m(n) {
        ...
        if (
          ...
          for (var x = i.allpts, w = 0; w + 3 < x.length; w += 2)
            if (
              hn(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], v) &&
              p > (r = vn(e, t, x[w], x[w + 1], x[w + 2], x[w + 3]))
            )
              return (g(n, r), !0);
        } else if (
          "bezier" === i.edgeType ||
      ...
      function x(n, r) {
        ...
        if ("yes" === n.pstyle("text-events").strValue && l) {
          ...
          if (d) {
            ...
            if (gn(e, t, B)) return (g(n), !0);
          } else if (on(s, e, t)) return (g(n), !0);
        }
      }
      n && (l = l.interactive);
      ...
      for (var m = 0; m < a.length; m++) {
        ...
        if (b.isNode()) {
          ...
          if ("contain" === E) {
            ...
            if (k && w) {
              var S = g(x);
              S && Rn(S, f) && (s.push(x), (P = !0));
            }
            !P && ln(h, C) && s.push(x);
          } else if ("overlap" === E && an(h, C)) {
            var B = x.boundingBox({
              includeNodes: !0,
              includeEdges: !0,
              includeLabels: !1,
          ...
          if ("contain" === R) {
            if (
              null != M.startX &&
              null != M.startY &&
              !on(h, M.startX, M.startY)
            )
              continue;
            if (null != M.endX && null != M.endY && !on(h, M.endX, M.endY))
              continue;
            if (
              "bezier" === M.edgeType ||
            ...
            if (
              ...
              null != M.endX &&
              null != M.endY &&
              (on(h, M.startX, M.startY) || on(h, M.endX, M.endY))
            )
              (s.push(_), (z = !0));
...
uc.getArrowWidth = uc.getArrowHeight = function (e, t) {
...
var cc,
  ...
  _c = function (e, t, n, r, a) {
    ...
    if (
      ...
      Dc(t, n, Bc),
      (hc = Sc.nx * Bc.ny - Sc.ny * Bc.nx),
      (fc = Sc.nx * Bc.nx - Sc.ny * -Bc.ny),
      (gc = Math.asin(Math.max(-1, Math.min(1, hc)))),
      Math.abs(gc) < 1e-6)
    )
      return ((cc = t.x), (dc = t.y), void (mc = xc = 0));
    ((pc = 1),
      (vc = !1),
      fc < 0
        ? gc < 0
          ? (gc = Math.PI + gc)
          : ((gc = Math.PI - gc), (pc = -1), (vc = !0))
        : gc > 0 && ((pc = -1), (vc = !0)),
      (xc = void 0 !== t.radius ? t.radius : r),
      (yc = gc / 2),
      (wc = Math.min(Sc.len / 2, Bc.len / 2)),
      a
        ? (bc = Math.abs((Math.cos(yc) * xc) / Math.sin(yc))) > wc
          ? ((bc = wc), (mc = Math.abs((bc * Math.sin(yc)) / Math.cos(yc))))
          : (mc = xc)
        : ((bc = Math.min(wc, xc)),
          (mc = Math.abs((bc * Math.sin(yc)) / Math.cos(yc)))),
      (Tc = t.x + Bc.nx * bc),
      (Cc = t.y + Bc.ny * bc),
      (cc = Tc - Bc.ny * mc * pc),
      (dc = Cc + Bc.nx * mc * pc),
    ...
    : (_c(e, t, n, r, a),
      {
        ...
        stopX: Tc,
        stopY: Cc,
        startAngle: Sc.ang + (Math.PI / 2) * pc,
        endAngle: Bc.ang - (Math.PI / 2) * pc,
        counterClockwise: vc,
      });
}
var Rc = 0.01,
...
((Nc.findMidptPtsEtc = function (e, t) {
  ...
  (Nc.findLoopPoints = function (e, t, n, r) {
  ...
  (Nc.findCompoundLoopPoints = function (e, t, n, r) {
    var a = e._private.rscratch;
    a.edgeType = "compound";
    var i = t.srcPos,
      o = t.tgtPos,
    ...
    var g = { x: i.x - s / 2, y: i.y - l / 2 },
      ...
      b = Math.max(0.5, Math.log(s * Rc)),
      x = Math.max(0.5, Math.log(u * Rc));
    a.ctrlpts = [
      m.x,
  ...
  (Nc.findBezierPoints = function (e, t, n, r, a) {
  ...
  (Nc.checkForInvalidEdgeWarning = function (e) {
    ...
    t.nodesOverlap || (G(t.startX) && G(t.startY) && G(t.endX) && G(t.endY))
      ? (t.loggedErr = !1)
      : t.loggedErr || ((t.loggedErr = !0), rt(e.id()));
  }),
            ...
            for (var _ = 0; _ < d.eles.length; _++) {
              ...
              if (
                ...
                var L = T.intersectLine(y.x, y.y, b, x, m.x, m.y, 0, P, D),
                  ...
                  q = Math.sqrt(Y * Y + j * j);
                (G(q) && q >= Ic) ||
                  (q = Math.sqrt(Math.max(Y * Y, Rc) + Math.max(j * j, Rc)));
...
var zc = {
    ...
    findEndpoints: function (e) {
      ...
      var re = Pn(i, o, c.arrowShapes[v].spacing(e) + y),
        ae = Pn(i, o, c.arrowShapes[v].gap(e) + y);
      if (
        ((E.endX = ae[0]),
        (E.endY = ae[1]),
        (E.arrowEndX = re[0]),
        ...
        if (ve.length > 0) {
          ...
          if ((me < ye && ((i = [ve[0], ve[1]]), (be = me)), ve.length > 2))
            Ht(ge, { x: ve[2], y: ve[3] }) < be && (i = [ve[2], ve[3]]);
        }
      }
      var xe = Pn(i, s, c.arrowShapes[g].spacing(e) + m),
        we = Pn(i, s, c.arrowShapes[g].gap(e) + m);
      ((E.startX = we[0]),
        (E.startY = we[1]),
        (E.arrowStartX = xe[0]),
        (E.arrowStartY = xe[1]),
...
((Oc.storeEdgeProjections = function (e) {
  var t = e._private,
    n = t.rscratch,
    r = n.edgeType;
  if (
    ...
    for (var a = 0; a + 5 < n.allpts.length; a += 4)
      Vc(this, e, n.allpts.slice(a, a + 6));
  } else if ("segments" === r) {
  ...
  (Oc.recalculateEdgeProjections = function (e) {
...
((Fc.recalculateEdgeLabelProjections = function (e) {
  var t,
    n = e._private,
    r = n.rscratch,
    a = this,
  ...
  if (i.mid || i.source || i.target) {
    ...
    var s = Xc(r.midDispX, r.midDispY);
  ...
  (Fc.applyPrefixedLabelDimensions = function (e, t) {
    ...
    if (dt(n.rscratch, "prefixedLabelDimsKey", t) !== a) {
      ...
      var i = this.calculateLabelDimensions(e, r),
        ...
        l = dt(n.rscratch, "labelWrapCachedLines", t) || [],
  ...
  (Fc.getLabelJustification = function (e) {
  ...
  (Fc.calculateLabelDimensions = function (e, t) {
  ...
  (Fc.calculateLabelAngle = function (e, t) {
    var n = e._private.rscratch,
      r = e.isEdge(),
      a = t ? t + "-" : "",
  ...
  (Fc.calculateLabelAngles = function (e) {
    var t = this,
      n = e.isEdge(),
...
var Wc = {
  ...
  Hc = {};
[lc, uc, Nc, zc, Oc, Fc, Yc, Wc, Uc].forEach(function (e) {
  ge(Hc, e);
});
var Kc = {
...
((Gc.binder = function (e) {
  ...
  (Gc.nodeIsDraggable = function (e) {
    return e && e.isNode() && !e.locked() && e.grabbable();
  }),
  (Gc.nodeIsGrabbable = function (e) {
            ...
            if (g) {
              ...
              (b ? b.emit(_) : o.emit(_),
                ...
                (e.hoverData.cxtOver && v === e.hoverData.cxtOver) ||
                  (e.hoverData.cxtOver &&
                    e.hoverData.cxtOver.emit(B("cxtdragout")),
              ...
              if (g) {
                if (o.boxSelectionEnabled() && P)
                  (b &&
                    ...
                    w.emit(B("free")),
                    e.dragData.didDrag &&
                      (b.emit(B("dragfreeon")), w.emit(B("dragfree")))),
                    D());
                ...
                0 ===
                (S = e.hoverData.dragDelta = e.hoverData.dragDelta || []).length
  ...
  generatePolygon: function (e, t) {
    return (this.nodeShapes[e] = {
      ...
      intersectLine: function (e, t, n, r, a, i, o, s) {
        return Cn(a, i, this.points, e, t, n / 2, r / 2, o);
      },
      checkPoint: function (e, t, n, r, a, i, o, s) {
        return yn(e, t, this.points, i, o, r, a, [0, -1], n);
      },
      hasMiterBounds: "rectangle" !== e,
      miterBounds: function (e, t, n, r, a, i) {
        return cn(this.points, e, t, n, r, a);
      },
    });
  },
};
((Zc.generateEllipse = function () {
  return (this.nodeShapes.ellipse = {
    ...
    checkPoint: function (e, t, n, r, a, i, o, s) {
      return xn(e, t, r, a, i, o, n);
    },
  });
}),
  (Zc.generateRoundPolygon = function (e, t) {
    return (this.nodeShapes[e] = {
      renderer: this,
      name: e,
      points: t,
        ...
        return (function (e, t, n, r, a, i, o, s, l) {
          ...
          l.forEach(function (n, i) {
            (0 === i
              ...
              (d[4 * i] = n.stopX),
              (d[4 * i + 1] = n.stopY),
              0 !== (u = wn(e, t, r, a, n.cx, n.cy, n.radius)).length &&
                c.push(u[0], u[1]));
          });
  ...
  (Zc.generateRoundRectangle = function () {
      ...
      this.nodeShapes.roundrectangle =
        {
          ...
          checkPoint: function (e, t, n, r, a, i, o, s) {
            ...
            return (
              !!yn(e, t, this.points, i, o, r, a - c, [0, -1], n) ||
              !!yn(e, t, this.points, i, o, r - c, a, [0, -1], n) ||
              !!xn(e, t, c, c, i - l + s, o - u + s, n) ||
              !!xn(e, t, c, c, i + l - s, o - u + s, n) ||
              !!xn(e, t, c, c, i + l - s, o + u - s, n) ||
              !!xn(e, t, c, c, i - l + s, o + u - s, n)
            );
  ...
  (Zc.generateCutRectangle = function () {
    return (this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle =
      {
        ...
        checkPoint: function (e, t, n, r, a, i, o, s) {
          ...
          if (yn(e, t, this.points, i, o, r, a - 2 * l, [0, -1], n)) return !0;
          if (yn(e, t, this.points, i, o, r - 2 * l, a, [0, -1], n)) return !0;
    ...
    return (this.nodeShapes.barrel = {
      ...
      checkPoint: function (e, t, n, r, a, i, o, s) {
        var l = Mn(r, a),
          u = l.heightOffset,
          c = l.widthOffset;
        if (yn(e, t, this.points, i, o, r, a - 2 * u, [0, -1], n)) return !0;
        if (yn(e, t, this.points, i, o, r - 2 * c, a, [0, -1], n)) return !0;
        for (
  ...
  (Zc.generateBottomRoundrectangle = function () {
      ...
      this.nodeShapes.bottomroundrectangle =
        {
          ...
          intersectLine: function (e, t, n, r, a, i, o, s) {
            var l = t - (r / 2 + o),
              u = kn(a, i, e, t, e - (n / 2 + o), l, e + (n / 2 + o), l, !1);
            return u.length > 0 ? u : dn(a, i, e, t, n, r, o, s);
          },
          checkPoint: function (e, t, n, r, a, i, o, s) {
            var l = 2 * (s = "auto" === s ? _n(r, a) : s);
            if (yn(e, t, this.points, i, o, r, a - l, [0, -1], n)) return !0;
            if (yn(e, t, this.points, i, o, r - l, a, [0, -1], n)) return !0;
            var u = r / 2 + 2 * n,
              c = a / 2 + 2 * n;
            return (
              !!gn(e, t, [i - u, o - c, i - u, o, i + u, o, i + u, o - c]) ||
              !!xn(e, t, l, l, i + r / 2 - s, o + a / 2 - s, n) ||
              !!xn(e, t, l, l, i - r / 2 + s, o + a / 2 - s, n)
            );
          },
        });
  }),
  (Zc.registerNodeShapes = function () {
    var e = (this.nodeShapes = {}),
      t = this;
    (this.generateEllipse(),
      this.generatePolygon("triangle", Sn(3, 0)),
      this.generateRoundPolygon("round-triangle", Sn(3, 0)),
      this.generatePolygon("rectangle", Sn(4, 0)),
    ...
    (this.generatePolygon("diamond", n),
      ...
      this.generatePolygon("pentagon", Sn(5, 0)),
      this.generateRoundPolygon("round-pentagon", Sn(5, 0)),
      this.generatePolygon("hexagon", Sn(6, 0)),
      this.generateRoundPolygon("round-hexagon", Sn(6, 0)),
      this.generatePolygon("heptagon", Sn(7, 0)),
      this.generateRoundPolygon("round-heptagon", Sn(7, 0)),
      this.generatePolygon("octagon", Sn(8, 0)),
      this.generateRoundPolygon("round-octagon", Sn(8, 0)));
    var r = new Array(20),
      a = Dn(5, 0),
      i = Dn(5, Math.PI / 5),
      o = 0.5 * (3 - Math.sqrt(5));
...
((ed.clientFunctions = [
  ...
  (ed.init = function (e) {
    ...
    if (r) {
      ...
      "static" === r.getComputedStyle(n).getPropertyValue("position") && rt();
    }
  ...
  (ed.isHeadless = function () {
    return !1;
  }),
  [sc, Hc, Kc, Gc, Zc, $c].forEach(function (e) {
    ge(ed, e);
  }));
var td = 1e3 / 60,
  nd = function (e) {
      ...
      if (!t.dequeueingSetup) {
        ...
        n.beforeRender(function (a, i) {
          ...
          for (a || n.flushRenderedStyleQueue(); ; ) {
            ...
            } else if (p >= e.deqNoDrawCost * td) break;
            var g = e.deq(t, d, c);
            if (!(g.length > 0)) break;
  ...
  sd = function (e, t) {
    ...
    var r = od(t);
    (ge(n, r),
      (n.lookup = new rd(r.getKey, r.doesEleInvalidateKey)),
      n.setupDequeueing());
  },
  ld = sd.prototype;
((ld.reasons = id),
  (ld.getTextureQueue = function (e) {
    var t = this;
    return (
  ...
  (ld.getRetiredTextureQueue = function (e) {
    var t = (this.eleImgCaches.retired = this.eleImgCaches.retired || {});
    return (t[e] = t[e] || []);
  }),
  (ld.getElementQueue = function () {
  ...
  (ld.getElementKeyToQueue = function () {
    return (this.eleKeyToCacheQueue = this.eleKeyToCacheQueue || {});
  }),
  (ld.getElement = function (e, t, n, r, a) {
    var i = this,
      o = this.renderer,
      s = o.cy.zoom(),
      l = this.lookup;
    ...
    if (
      ...
      for (var S = m.level; S > r; S--)
        C = i.getElement(e, t, n, S, id.downscale);
      P();
    } else {
      var B;
      if (!x && !w && !E)
  ...
  (ld.invalidateElement = function (e) {
    var t = this,
      n = t.lookup,
      r = [];
    if (n.isInvalid(e)) {
  ...
  (ld.recycleTexture = function (e, t) {
    for (
  ...
  (ld.dequeue = function (e) {
    for (
      ...
      if (((r[l] = null), !c)) {
        ...
        t.getElement(u, d, e, s.level, id.dequeue);
      }
    }
    return a;
  }),
  (ld.removeFromQueue = function (e) {
  ...
  (ld.onDequeue = function (e) {
    this.onDequeues.push(e);
  }),
  (ld.offDequeue = function (e) {
    ut(this.onDequeues, e);
  }),
  (ld.setupDequeueing = nd({
...
((cd.makeLayer = function (e, t) {
  ...
  (cd.getLayers = function (e, t, n) {
    ...
    var d = function (t) {
      ...
      !(function () {
        if (!o) {
          o = Qt();
          for (var t = 0; t < e.length; t++) Jt(o, e[t].boundingBox());
        }
      })();
    ...
    for (var h = null, f = e.length / 1, p = !i, v = 0; v < e.length; v++) {
      ...
      if (b) h = b;
        ...
        if (
          (!h || h.eles.length >= f || !ln(h.bb, g.boundingBox())) &&
  ...
  (cd.getEleLevelForLayerLevel = function (e, t) {
    return e;
  }),
  (cd.drawEleInLayer = function (e, t, n, r) {
    var a = this.renderer,
      i = e.context,
      o = t.boundingBox();
    0 !== o.w &&
  ...
  (cd.levelIsComplete = function (e, t) {
  ...
  (cd.validateLayersElesOrdering = function (e, t) {
    var n = this.layersByLevel[e];
    if (n)
      for (var r = 0; r < n.length; r++) {
  ...
  (cd.updateElementsInLayers = function (e, t) {
  ...
  (cd.invalidateElements = function (e) {
    var t = this;
    0 !== e.length &&
  ...
  (cd.refineElementTextures = function (e) {
    var t = this;
    t.updateElementsInLayers(e, function (e, n, r) {
      var a = e.replacement;
      if (
  ...
  (cd.enqueueElementRefinement = function (e) {
    (this.eleTxrDeqs.merge(e), this.scheduleElementRefinement());
  }),
  (cd.queueLayer = function (e, t) {
  ...
  (cd.applyLayerReplacement = function (e) {
  ...
  (cd.requestRedraw = De(function () {
    var e = this.renderer;
    (e.redrawHint("eles", !0), e.redrawHint("drag", !0), e.redraw());
  }, 100)),
  (cd.setupDequeueing = nd({
...
pd.arrowShapeImpl = function (e) {
  return (fd ||
    (fd = {
      polygon: vd,
      "triangle-backcurve": gd,
      "triangle-tee": yd,
      "circle-triangle": md,
      "triangle-cross": yd,
      circle: bd,
...
((xd.drawCachedElement = function (e, t, n, r, a, i) {
  var o = this,
    s = o.data,
    l = s.eleTxrCache,
    u = s.lblTxrCache,
  ...
  if (0 !== h.w && 0 !== h.h && t.visible() && (!r || an(h, r))) {
    var p = t.isEdge(),
      v = t.element()._private.rscratch.badLine;
    (o.drawElementUnderlay(e, t),
      o.drawCachedElementPortion(e, t, l, n, a, f, wd, Cd),
      (p && v) || o.drawCachedElementPortion(e, t, u, n, a, f, Ed, Pd),
      p &&
        !v &&
        (o.drawCachedElementPortion(e, t, c, n, a, f, kd, Pd),
        o.drawCachedElementPortion(e, t, d, n, a, f, Td, Pd)),
      o.drawElementOverlay(e, t));
  }
}),
  (xd.drawElements = function (e, t) {
    for (var n = 0; n < t.length; n++) {
      var r = t[n];
      this.drawElement(e, r);
    }
  }),
  (xd.drawCachedElements = function (e, t, n, r) {
    for (var a = 0; a < t.length; a++) {
      var i = t[a];
      this.drawCachedElement(e, i, n, r);
    }
  }),
  (xd.drawCachedNodes = function (e, t, n, r) {
    for (var a = 0; a < t.length; a++) {
      var i = t[a];
      i.isNode() && this.drawCachedElement(e, i, n, r);
    }
  }),
  (xd.drawLayeredElements = function (e, t, n, r) {
...
((Sd.drawEdgeOverlay = Bd("overlay")),
  (Sd.drawEdgeUnderlay = Bd("underlay")),
  (Sd.drawEdgePath = function (e, t, n, a) {
    var i,
  ...
  (Sd.drawEdgeTrianglePath = function (e, t, n) {
  ...
  (Sd.drawArrowheads = function (e, t, n) {
  ...
  (Sd.drawArrowhead = function (e, t, n, r, a, i, o) {
    if (
  ...
  (Sd.drawArrowShape = function (e, t, n, r, a, i, o, s, l) {
    var u,
      c = this,
...
((_d.eleTextBiggerThanMin = function (e, t) {
  if (!t) {
    var n = e.cy().zoom(),
  ...
  (_d.drawElementText = function (e, t, n, r, a) {
  ...
  (_d.setupTextStyle = function (e, t) {
    var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
  ...
  (_d.drawText = function (e, t, n) {
    ...
    if (!a || (0 !== o && 0 !== t.pstyle("text-opacity").value)) {
      ...
      if (null != b && "" !== b && !isNaN(y) && !isNaN(m)) {
        ...
        if (
          (G > 0 && (e.lineWidth = G), "wrap" === t.pstyle("text-wrap").value)
        ) {
          var Z = dt(i, "labelWrapCachedLines", n),
            $ = dt(i, "labelLineHeight", n),
            Q = E / 2,
...
((Md.drawNodeOverlay = Rd("overlay")),
  (Md.drawNodeUnderlay = Rd("underlay")),
  (Md.hasPie = function (e) {
    return (e = e[0])._private.hasPie;
  }),
  (Md.hasStripe = function (e) {
    return (e = e[0])._private.hasStripe;
  }),
  (Md.drawPie = function (e, t, n, r) {
  ...
  (Md.drawStripe = function (e, t, n, r) {
    ((t = t[0]), (r = r || t.position()));
    var a = t.cy().style(),
      i = r.x,
      o = r.y,
...
function Hd(e, t, n, r) {
  ...
  for (var h = new Array(t), f = 0; f < t; f++) h[f] = Ud(e, s, u, c, o, f);
  return (
    (d.dataArray = u),
    (d.stride = c),
    (d.size = o),
...
((Nd.getPixelRatio = function () {
  ...
  (Nd.createGradientStyleFor = function (e, t, n, r, a) {
    var i,
      o = this.usePaths(),
  ...
  (Nd.gradientFillStyle = function (e, t, n, r) {
    var a = this.createGradientStyleFor(e, "background", t, n, r);
    if (!a) return null;
    e.fillStyle = a;
  }),
  (Nd.colorFillStyle = function (e, t, n, r, a) {
    e.fillStyle = "rgba(" + t + "," + n + "," + r + "," + a + ")";
  }),
  (Nd.eleFillStyle = function (e, t, n) {
  ...
  (Nd.gradientStrokeStyle = function (e, t, n, r) {
    var a = this.createGradientStyleFor(e, "line", t, n, r);
    if (!a) return null;
    e.strokeStyle = a;
  }),
  (Nd.colorStrokeStyle = function (e, t, n, r, a) {
    e.strokeStyle = "rgba(" + t + "," + n + "," + r + "," + a + ")";
  }),
  (Nd.eleStrokeStyle = function (e, t, n) {
  ...
  (Nd.drawSelectionRectangle = function (e, t) {
    var n = this,
      r = n.cy,
      a = n.data,
      i = r.style(),
    ...
    if (n.showFps || (!o && l[n.SELECT_BOX] && !s)) {
      ...
      if (n.showFps && p) {
        ...
        if (
          ...
          Id = y.actualBoundingBoxAscent;
        }
        c.fillText(g, 0, Id);
        (c.strokeRect(0, Id + 10, 250, 20),
          c.fillRect(0, Id + 10, 250 * Math.min(v / 60, 1), 20));
      }
      s || (l[n.SELECT_BOX] = !1);
    }
  }));
var Kd = "undefined" != typeof Float32Array ? Float32Array : Array;
function Gd() {
  var e = new Kd(9);
  return (
    Kd != Float32Array &&
                    ...
                    for (v.s(); !(p = v.n()).done; ) {
                      ...
                      if (!f.has(g)) {
                        ...
                        (l.canFit({ w: m.w + b.w, h: m.h }) ||
                          ...
                          d.canvas &&
                            (e._copyTextureToNewAtlas(g, d, l), s.set(g, l)));
                      }
                    }
                  } catch (x) {
                    v.e(x);
    ...
    return n(
      function e(n, r, a) {
        (t(this, e),
          ...
          (this.batchDebugInfo = []),
          (a.enableWrapping = !0),
          (a.createTextureCanvas = zd),
          (this.atlasManager = new nh(n, a)),
          (this.batchManager = new rh(a)),
          (this.simpleShapeOptions = new Map()),
          (this.program = this._createShaderProgram(ah.SCREEN)),
          (this.pickingProgram = this._createShaderProgram(ah.PICKING)),
      ...
      [
        ...
        },
        {
          ...
          value: function (e) {
            var t = this.gl,
              ...
              a = (function (e, t, n) {
                var r = Ld(e, e.VERTEX_SHADER, t),
                  a = Ld(e, e.FRAGMENT_SHADER, n),
                  i = e.createProgram();
                if (
                  (e.attachShader(i, r),
                  e.attachShader(i, a),
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              ...
              (this.indexBuffer = Hd(n, t, "vec4", r.aIndex)),
              (this.vertTypeBuffer = Hd(n, t, "int", r.aVertType)),
              (this.atlasIdBuffer = Hd(n, t, "int", r.aAtlasId)),
              (this.texBuffer = Hd(n, t, "vec4", r.aTex)),
              (this.pointAPointBBuffer = Hd(n, t, "vec4", r.aPointAPointB)),
              (this.pointCPointDBuffer = Hd(n, t, "vec4", r.aPointCPointD)),
              (this.lineWidthBuffer = Hd(n, t, "vec2", r.aLineWidth)),
              (this.colorBuffer = Hd(n, t, "vec4", r.aColor)),
              (this.cornerRadiusBuffer = Hd(n, t, "vec4", r.aCornerRadius)),
              (this.borderColorBuffer = Hd(n, t, "vec4", r.aBorderColor)),
          ...
          value: function (e, t, n) {
            ...
            if (
              ...
              if (this.renderTarget.picking && s.getTexPickingMode) {
                ...
                if (l === ih) return;
                if (l == oh) return void this.drawPickingRectangle(e, t, n);
              }
              var u,
                  ...
                  for (
                    ...
                    if (0 != b.w) {
                      ...
                      ((this.vertTypeBuffer.getView(w)[0] = 0),
                        jd(t, this.indexBuffer.getView(w)),
        ...
        },
        {
          ...
          value: function (e, t, n) {
            ...
            ((this.vertTypeBuffer.getView(a)[0] = 4),
              jd(t, this.indexBuffer.getView(a)),
              Xd([0, 0, 0], 1, this.colorBuffer.getView(a)));
          ...
          value: function (e, t, n) {
            ...
            if (this._isVisible(e, r)) {
              ...
              if (void 0 === i || (r.isSimple && !r.isSimple(e)))
                ...
                (jd(t, this.indexBuffer.getView(o)),
                  Xd(
        ...
        },
        {
          ...
          value: function (e, t, n) {
            var r = n.w,
              a = n.h;
            if ("auto" === e.pstyle(t).value) return _n(r, a);
              ...
              if (
                ...
                if ("none" !== e.pstyle(n + "-arrow-shape").value) {
                  ...
                  (Zd(f),
                    ...
                    jd(t, this.indexBuffer.getView(h)),
                    Xd(s, l, this.colorBuffer.getView(h)),
                    this.instanceCount++,
                    this.instanceCount >= this.maxInstances && this.endBatch());
                }
            }
              ...
              if (n) {
                ...
                if (
                  ...
                  ((this.vertTypeBuffer.getView(l)[0] = 1),
                    jd(t, this.indexBuffer.getView(l)),
                    Xd(o, s, this.colorBuffer.getView(l)),
                  ...
                  for (var c = 0; c < n.length - 2; c += 2) {
                    ...
                    ((this.vertTypeBuffer.getView(d)[0] = 2),
                      jd(t, this.indexBuffer.getView(d)),
                      Xd(o, s, this.colorBuffer.getView(d)),
...
lh.initWebgl = function (e, t) {
  ...
  var o = function (e) {
    ...
    u = function (e) {
      return "yes" === e.pstyle("text-events").strValue ? oh : ih;
    },
    c = function (e) {
      var t = e.position(),
        n = t.x,
  ...
  (n.drawing.addAtlasCollection("node", { texRows: e.webglTexRowsNodes }),
    ...
    n.drawing.addTextureAtlasRenderType("edge-source-label", {
      collection: "label",
      getTexPickingMode: u,
      getKey: ch(t.getSourceLabelKey, "source"),
    ...
    n.drawing.addTextureAtlasRenderType("edge-target-label", {
      collection: "label",
      getTexPickingMode: u,
      getKey: ch(t.getTargetLabelKey, "target"),
...
function ph(e, t, n) {
  ...
  if (
    ...
    if (((o = u.length), i.startFrame(l, n), n.screen)) {
      for (var c = 0; c < u.nondrag.length; c++) fh(e, c, u.nondrag[c]);
      for (var d = 0; d < u.drag.length; d++) fh(e, d, u.drag[d]);
    } else if (n.picking) for (var h = 0; h < u.length; h++) fh(e, h, u[h]);
    (i.endFrame(),
      n.screen &&
...
for (
  var vh = {
      ...
      drawRoundRectanglePath: function (e, t, n, r, a, i) {
        var o = r / 2,
          s = a / 2,
          l = "auto" === i ? _n(r, a) : Math.min(i, s, o);
        (e.beginPath && e.beginPath(),
          e.moveTo(t, n - s),
  ...
  ((mh[wh] = Math.sin(wh)), (bh[wh] = Math.cos(wh)));
vh.drawEllipsePath = function (e, t, n, r, a) {
  if ((e.beginPath && e.beginPath(), e.ellipse))
    ...
    for (
      ...
      ((i = t - s * mh[u] * gh + s * bh[u] * yh),
        (o = n + l * bh[u] * gh + l * mh[u] * yh),
...
((Eh.createBuffer = function (e, t) {
  var n = document.createElement("canvas");
  return ((n.width = e), (n.height = t), [n, n.getContext("2d")]);
}),
  (Eh.bufferCanvasImage = function (e) {
    var t = this.cy,
  ...
  (Eh.png = function (e) {
    return Th(e, this.bufferCanvasImage(e), "image/png");
  }),
  (Eh.jpg = function (e) {
    return Th(e, this.bufferCanvasImage(e), "image/jpeg");
  }));
var Ch = {
...
function Bh(e) {
  ...
  (e.webgl && (Sh.CANVAS_LAYERS = t.CANVAS_LAYERS = 4),
    (t.data = {
      canvases: new Array(Sh.CANVAS_LAYERS),
      contexts: new Array(Sh.CANVAS_LAYERS),
      canvasNeedsRedraw: new Array(Sh.CANVAS_LAYERS),
      bufferCanvases: new Array(Sh.BUFFER_COUNT),
      bufferContexts: new Array(Sh.CANVAS_LAYERS),
    }));
  ...
  for (var l = 0; l < Sh.CANVAS_LAYERS; l++) {
    ...
    ((t.data.contexts[l] = u.getContext(c)),
      ...
      (u.style.zIndex = String(Sh.CANVAS_LAYERS - l)),
      t.data.canvasContainer.appendChild(u),
      (t.data.canvasNeedsRedraw[l] = !1));
  }
  ((t.data.topCanvas = t.data.canvases[0]),
    t.data.canvases[Sh.NODE].setAttribute(
      "data-id",
      "layer" + Sh.NODE + "-node",
    ),
    t.data.canvases[Sh.SELECT_BOX].setAttribute(
      "data-id",
      "layer" + Sh.SELECT_BOX + "-selectbox",
    ),
    t.data.canvases[Sh.DRAG].setAttribute(
      "data-id",
      "layer" + Sh.DRAG + "-drag",
    ),
    t.data.canvases[Sh.WEBGL] &&
      t.data.canvases[Sh.WEBGL].setAttribute(
        "data-id",
        "layer" + Sh.WEBGL + "-webgl",
      ));
  for (l = 0; l < Sh.BUFFER_COUNT; l++)
...
((Sh.CANVAS_LAYERS = 3),
  ...
  (Sh.NODE = 2),
  (Sh.WEBGL = 3),
  (Sh.CANVAS_TYPES = ["2d", "2d", "2d", "webgl2"]),
  (Sh.BUFFER_COUNT = 3),
  (Sh.TEXTURE_BUFFER = 0),
  (Sh.MOTIONBLUR_BUFFER_NODE = 1),
  (Sh.MOTIONBLUR_BUFFER_DRAG = 2),
  (Sh.redrawHint = function (e, t) {
    var n = this;
    switch (e) {
      case "eles":
        n.data.canvasNeedsRedraw[Sh.NODE] = t;
        break;
      case "drag":
        n.data.canvasNeedsRedraw[Sh.DRAG] = t;
        break;
      case "select":
        n.data.canvasNeedsRedraw[Sh.SELECT_BOX] = t;
        break;
      case "gc":
        n.data.gc = !0;
    }
  }));
var Dh = "undefined" != typeof Path2D;
((Sh.path2dEnabled = function (e) {
  if (void 0 === e) return this.pathsEnabled;
  this.pathsEnabled = !!e;
}),
  (Sh.usePaths = function () {
    return Dh && this.pathsEnabled;
  }),
  (Sh.setImgSmoothing = function (e, t) {
  ...
  (Sh.makeOffscreenCanvas = function (e, t) {
    var n;
    "undefined" !==
  ...
  [pd, xd, Sd, Dd, _d, Md, Nd, lh, vh, Eh, Ch].forEach(function (e) {
    ge(Sh, e);
  }));
var _h = [
    { type: "layout", extensions: rc },
    {
      type: "renderer",
      extensions: [
        { name: "null", impl: ac },
...
function Rh(e, t, n) {
  ...
  if ("core" === e) {
    if (gu.prototype[t]) return a();
    gu.prototype[t] = n;
  } else if ("collection" === e) {
    if (Ml.prototype[t]) return a();
    Ml.prototype[t] = n;
  } else if ("layout" === e) {
    for (
      var i = function (e) {
  ...
  return be({ map: Ah, keys: [e, t], value: r });
}
function Ih(e, t) {
  return xe({ map: Ah, keys: [e, t] });
}
function Nh(e, t, n, r, a) {
  return be({ map: Mh, keys: [e, t, n, r], value: a });
}
function Lh(e, t, n, r) {
  return xe({ map: Mh, keys: [e, t, n, r] });
}
var zh = function () {
...
var Oh = function () {
    if (!(this instanceof Oh)) return new Oh();
    this.length = 0;
  },
  Vh = Oh.prototype;
    ...
    if (W(e)) this[n].properties.push({ name: e, value: t });
      ...
      for (var r = e, a = Object.keys(r), i = 0; i < a.length; i++) {
        var o = a[i],
          s = r[o];
        if (null != s) {
          var l = du.properties[o] || du.properties[oe(o)];
          if (null != l) {
            var u = l.name,
              c = s;
...
var Fh = function (e) {
  return (
    void 0 === e && (e = {}),
    K(e) ? new gu(e) : W(e) ? zh.apply(zh, arguments) : void 0
  );
};
((Fh.use = function (e) {
  var t = Array.prototype.slice.call(arguments, 1);
  return (t.unshift(Fh), e.apply(null, t), this);
}),
  (Fh.warnings = function (e) {
    return nt(e);
  }),
  (Fh.version = "3.33.1"),
  (Fh.stylesheet = Fh.Stylesheet = Oh));
export { Fh as c };
