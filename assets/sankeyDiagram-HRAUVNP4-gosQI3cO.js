...
import { o as g } from "./ordinal-CVjKTKEW.js";
  ...
  function d() {
    ...
    return (
      (function ({ nodes: t, links: n }) {
        ...
        const i = new Map(t.map((n, e) => [l(n, e, t), n]));
      ...
      (function ({ nodes: t }) {
        for (const n of t)
          n.value =
            void 0 === n.fixedValue
              ? Math.max(k(n.sourceLinks, A), k(n.targetLinks, A))
              : n.fixedValue;
      })(d),
      (function ({ nodes: t }) {
        const n = t.length;
      ...
      (function (e) {
        const l = (function ({ nodes: t }) {
          ...
          for (const n of t) {
            const t = Math.max(
              0,
              Math.min(e - 1, Math.floor(h.call(null, n, e))),
            );
            ((n.layer = t),
              (n.x0 = i + t * s),
              (n.x1 = n.x0 + a),
        ...
        ((t = Math.min(c, (o - s) / (x(l, (t) => t.length) - 1))),
          (function (n) {
            const e = m(n, (n) => (o - s - (n.length - 1) * t) / k(n, A));
            for (const i of n) {
              let n = s;
              for (const s of i) {
  ...
  return (
    ...
    (d.nodeId = function (t) {
      return arguments.length
        ? ((l = "function" == typeof t ? t : w(t)), d)
        : l;
    }),
    (d.nodeAlign = function (t) {
      return arguments.length
        ? ((h = "function" == typeof t ? t : w(t)), d)
        : h;
    }),
    ...
    (d.nodePadding = function (n) {
      return arguments.length ? ((c = t = +n), d) : c;
    }),
    (d.nodes = function (t) {
      return arguments.length
        ? ((u = "function" == typeof t ? t : w(t)), d)
        : u;
    }),
    (d.links = function (t) {
      return arguments.length
        ? ((f = "function" == typeof t ? t : w(t)), d)
        : f;
    }),
...
z.prototype = F.prototype = {
  ...
  arc: function (t, n, e, i, s, r) {
    ...
    (null === this._x1
      ? (this._ += "M" + c + "," + l)
      : (Math.abs(this._x1 - c) > $ || Math.abs(this._y1 - l) > $) &&
        (this._ += "L" + c + "," + l),
      e &&
        (u < 0 && (u = (u % C) + C),
        u > D
...
function R() {
  return (function (t) {
    ...
    return (
      ...
      (o.x = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : U(+t)), o)
          : i;
      }),
      (o.y = function (t) {
        return arguments.length
          ? ((s = "function" == typeof t ? t : U(+t)), o)
          : s;
      }),
...
var K = (function () {
  var t = l(function (t, n, e, i) {
    ...
    s = {
      ...
      performAction: l(function (t, n, e, i, s, r, o) {
        var a = r.length - 1;
        switch (s) {
          case 7:
            const t = i.findOrCreateNode(r[a - 4].trim().replaceAll('""', '"')),
              n = i.findOrCreateNode(r[a - 2].trim().replaceAll('""', '"')),
              e = parseFloat(r[a].trim());
            i.addLink(t, n, e);
            break;
          case 8:
          case 9:
      ...
      parse: l(function (t) {
        ...
        ("function" == typeof y.yy.parseError
          ...
          l(_, "lex"));
        for (var x, m, k, v, b, w, S, E, L = {}; ; ) {
          if (
            ((m = e[e.length - 1]),
            this.defaultActions[m]
              ? (k = this.defaultActions[m])
              : (null == x && (x = _()), (k = o[m] && o[m][x])),
          ...
          switch (k[0]) {
            ...
            case 2:
              ...
              (w &&
                ...
                (s = s.slice(0, -1 * w)),
                (r = r.slice(0, -1 * w))),
                e.push(this.productions_[k[1]][0]),
                s.push(L.$),
                r.push(L._$),
                (S = o[e[e.length - 2]][e[e.length - 1]]),
                e.push(S));
              break;
            case 3:
              return !0;
    ...
    r = (function () {
      return {
        ...
        performAction: l(function (t, n, e, i) {
          switch (e) {
            case 0:
            case 1:
...
var Z = K,
  ...
  lt = {
    nodesMap: tt,
    getConfig: l(() => h().sankey, "getConfig"),
    getNodes: ot,
    getLinks: at,
    getGraph: ct,
    addLink: it,
  ...
  ft = {
    draw: l(function (t, n, e, i) {
      const { securityLevel: s, sankey: r } = h(),
        o = u.sankey;
      let a;
      "sandbox" === s && (a = f("#i" + n));
      const c = f("sandbox" === s ? a.nodes()[0].contentDocument.body : "body"),
        d = "sandbox" === s ? c.select(`[id="${n}"]`) : f(`[id="${n}"]`),
        p = r?.width ?? o.width,
        x = r?.height ?? o.width,
        m = r?.useMaxWidth ?? o.useMaxWidth,
        k = r?.nodeAlignment ?? o.nodeAlignment,
        v = r?.prefix ?? o.prefix,
        b = r?.suffix ?? o.suffix,
        w = r?.showValues ?? o.showValues,
        S = i.db.getGraph(),
        E = ut[k];
      N()
        .nodeId((t) => t.id)
      ...
      d.append("g")
        ...
        .data(S.nodes)
        .join("text")
        .attr("x", (t) => (t.x0 < p / 2 ? t.x1 + 6 : t.x0 - 6))
        .attr("y", (t) => (t.y1 + t.y0) / 2)
        .attr("dy", (w ? "0" : "0.35") + "em")
        .attr("text-anchor", (t) => (t.x0 < p / 2 ? "start" : "end"))
        .text(A);
      const M = d
          .append("g")
          .attr("class", "links")
      ...
      switch (I) {
        case "gradient":
          T = l((t) => t.uid, "coloring");
          break;
        case "source":
          T = l((t) => L(t.source.id), "coloring");
          break;
        case "target":
          T = l((t) => L(t.target.id), "coloring");
          break;
        default:
          T = I;
      }
  ...
  pt = Z.parse.bind(Z);
Z.parse = (t) => pt(yt(t));
var gt = { styles: dt, parser: Z, db: lt, renderer: ft };
