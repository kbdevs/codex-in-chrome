(function () {
  !(function () {
    ...
    function y(e, t) {
      ...
      const n = null !== i && e === a && t === o;
      if (((a = e), (o = t), !i)) {
        const { container: n, styled: a } = (function (e, t) {
          ...
          const i = "http://www.w3.org/2000/svg",
            s = (e) => {
              ...
              for (const [n, i] of Object.entries(e)) t.setAttribute(n, i);
              return t;
            },
            a = (e, t, n, a) => {
              const o = document.createElementNS(i, "svg");
              return (
                (o.id = e),
                o.setAttribute("width", "20"),
                o.setAttribute("height", "26"),
                o.setAttribute("viewBox", "0 0 20 26"),
                (o.style.cssText = `position:absolute; top:0; left:0; overflow:visible; ${a}`),
                o.appendChild(
                  s({
                    stroke: t,
                    "stroke-width": "3",
                ...
                o.appendChild(s({ fill: n })),
                o
              );
            },
            o = a("claude-phantom-cursor-plain", "white", "#111", ""),
            r = a(
      ...
      return (
        (i.style.transform = `translate3d(${e}px, ${t}px, 0)`),
        n || document.hidden
          ? Promise.resolve()
          : new Promise((e) => {
              let t = !1;
              const n = () => {
                t ||
                  ((t = !0), i?.removeEventListener("transitionend", n), e());
              };
    ...
    function x() {
      ((l = !0),
        ...
        (function () {
          try {
            if (!r) {
              r = new AudioContext();
              const e = r.createGain();
              ((e.gain.value = 0), e.connect(r.destination));
              const t = r.createConstantSource();
              (t.connect(e),
                t.start(),
      ...
      try {
        (i ||
          y(
            a ?? Math.round(window.innerWidth / 2),
            o ?? Math.round(window.innerHeight / 2),
          ),
          s && (s.style.display = ""));
      } catch (n) {}
      requestAnimationFrame(() => {
        if ((e && (e.style.opacity = "1"), t)) {
          const e = t.querySelector("#claude-agent-stop-button");
        ...
        n
          ...
          : ((n = (function () {
              ...
              const i = e.querySelector("#claude-static-close-button"),
                s = e.querySelector("#claude-static-close-tooltip");
              return (
                i &&
    ...
    (chrome.runtime.onMessage.addListener((i, a, o) => {
      if ("SHOW_AGENT_INDICATORS" === i.type)
        ((u = u || !0 === i.isMcp), x(), o({ success: !0 }));
      else if ("HIDE_AGENT_INDICATORS" === i.type) (m(), o({ success: !0 }));
      else {
        if ("UPDATE_PHANTOM_CURSOR" === i.type)
          return (y(i.x, i.y).then(() => o({ success: !0 })), !0);
        "HIDE_FOR_TOOL_USE" === i.type
          ? ((c = l),
            (p = d),
            e && (e.style.display = "none"),
            t && (t.style.display = "none"),
            s && (s.style.display = "none"),
            n && d && (n.style.display = "none"),
            o({ success: !0 }))
          : "SHOW_AFTER_TOOL_USE" === i.type
            ? (c && (e && (e.style.display = ""), t && (t.style.display = "")),
              s && (s.style.display = ""),
              p && n && (n.style.display = ""),
              (c = !1),
              (p = !1),
              o({ success: !0 }))
            : "SHOW_STATIC_INDICATOR" === i.type
              ? (h(), o({ success: !0 }))
              : "HIDE_STATIC_INDICATOR" === i.type && (b(), o({ success: !0 }));
      }
    }),
      window.addEventListener("beforeunload", () => {
        (m(), b(), g(), r?.close().catch(() => {}), (r = null));
      }));
  })();
})();
