var e;
import { g as t } from "./chunk-WVR4S24B-DfY2Yl38.js";
  ...
  var e = i(function (e, t, s, i) {
    ...
    oe = {
      ...
      table: [
        ...
        e(C, [2, 85]),
        e(C, [2, 86]),
        { 62: 69, 65: v, 66: L, 67: x, 68: O, 69: w, 70: D, 71: M },
        { 62: 77, 65: v, 66: L, 67: x, 68: O, 69: w, 70: D, 71: M },
          ...
          switch (g[0]) {
            ...
            case 2:
              if (
                ...
                R &&
                  (N._$.range = [
                    a[a.length - (b || 1)].range[0],
                    a[a.length - 1].range[1],
                  ]),
                void 0 !==
                  (S = this.performAction.apply(
                    N,
                    [c, h, o, m.yy, g[1], r, a].concat(u),
                  )))
              )
                return S;
              (b &&
...
var I = i(async function (e, i, n, r) {
    ...
    (R.insertTitle(
      ...
      s(y, 8, "requirementDiagram", l?.useMaxWidth ?? !0));
  }, "draw"),
  b = {
    parser: f,
    get db() {
