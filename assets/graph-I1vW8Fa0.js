import { ar as e, as as t, at as s, au as i } from "./mermaid.core-NYzi0juk.js";
import { e as r, k as n } from "./useStorageState-zNVna44X.js";
import {
  a as h,
  c as o,
  f as d,
...
class g {
  constructor(e = {}) {
    ((this._isDirected =
      ...
      (this._nodes = {}),
      this._isCompound &&
        ((this._parent = {}), (this._children = {}), (this._children[p] = {})),
      (this._in = {}),
      (this._preds = {}),
      (this._out = {}),
      (this._sucs = {}),
  ...
  setDefaultNodeLabel(e) {
    return (r(e) || (e = s(e)), (this._defaultNodeLabelFn = e), this);
  }
  nodeCount() {
  ...
  isLeaf(e) {
    return (
      0 === (this.isDirected() ? this.successors(e) : this.neighbors(e)).length
    );
  }
  filterNodes(e) {
  ...
  setDefaultEdgeLabel(e) {
    return (r(e) || (e = s(e)), (this._defaultEdgeLabelFn = e), this);
  }
  edgeCount() {
  ...
  setEdge() {
    ...
    ("object" == typeof n && null !== n && "v" in n
      ...
      (t = "" + t),
      u(s) || (s = "" + s));
    var h = m(this._isDirected, e, t, s);
  ...
  edge(e, t, s) {
    var i =
      1 === arguments.length
        ? b(this._isDirected, arguments[0])
        : m(this._isDirected, e, t, s);
