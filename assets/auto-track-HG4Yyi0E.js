import { p as t } from "./useStorageState-zNVna44X.js";
        ...
        function (e) {
          e.addEventListener(
            ...
            function (a) {
              var u,
                c,
                s = n instanceof Function ? n(e) : n,
                f = r instanceof Function ? r(e) : r,
                l =
                  e.getAttribute("href") ||
                  e.getAttributeNS("http://www.w3.org/1999/xlink", "href") ||
                  e.getAttribute("xlink:href") ||
                  (null === (u = e.getElementsByTagName("a")[0]) || void 0 === u
                    ? void 0
                    : u.getAttribute("href")),
                h = t(
  ...
  return e
    ? (e instanceof HTMLFormElement && (e = [e]),
      e.forEach(function (e) {
        ...
        u ? u(e).submit(a) : e.addEventListener("submit", a, !1);
      }),
      this)
    : this;
}
