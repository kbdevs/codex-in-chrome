        ...
        if (
          ...
          for (e = -1, s = t.length; ++e < s; )
            if (48 > (c = t.charCodeAt(e)) || c > 57) {
              ((h = (46 === c ? u + t.slice(e + 1) : t.slice(e)) + h),
                (t = t.slice(0, e)));
              break;
            }
      }
      M && !f && (t = a(t, 1 / 0));
      var N = l.length + t.length + h.length,
        j = N < y ? new Array(y - N + 1).join(i) : "";
      switch (
        (M && f && ((t = a(j + t, j.length ? y - h.length : 1 / 0)), (j = "")),
        r)
      ) {
        case "<":
          t = l + t + h + j;
        ...
        case "=":
          ...
          break;
        case "^":
          t = j.slice(0, (N = j.length >> 1)) + l + t + h + j.slice(N);
          break;
        default:
          t = j + l + t + h;
      }
...
((l = g({ thousands: ",", grouping: [3], currency: ["$", ""] })),
  (h = l.format),
  (u = l.formatPrefix));
export { u as a, h as b, i as e, e as f };
