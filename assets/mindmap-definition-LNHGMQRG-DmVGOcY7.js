...
import { c as p } from "./cytoscape.esm-C95Vx2C1.js";
import { g as f } from "./index-BBLsn8fp.js";
      ...
      (t = function () {
        return (function (t) {
          ...
          function (t, e, i) {
            ...
            for (var c in ((l.prototype = Object.create(n.prototype)), n))
              l[c] = n[c];
          ...
          function (t, e, i) {
            ...
            for (var d in ((u.prototype = Object.create(n.prototype)), n))
              u[d] = n[d];
            ...
            ((o.prototype.addRoot = function () {
              ...
              (o.prototype.remove = function (t) {
                if (t instanceof n) {
                  ...
                  ((c = i.source.owner.getGraphManager().edges.indexOf(i)),
          ...
          function (t, e, i) {
            ...
            ((r.calcSeparationAmount = function (t, e, i, n) {
              ...
              (r.getIntersection2 = function (t, e, i) {
                ...
                if (n === o) {
                  if (r > s)
                    return ((i[0] = n), (i[1] = h), (i[2] = o), (i[3] = _), !1);
                  if (r < s)
                    return ((i[0] = n), (i[1] = g), (i[2] = o), (i[3] = y), !1);
                } else if (r === s) {
                  if (n > o)
                    return ((i[0] = a), (i[1] = r), (i[2] = E), (i[3] = s), !1);
                  if (n < o)
                    return ((i[0] = l), (i[1] = r), (i[2] = f), (i[3] = s), !1);
                } else {
                  ...
                  if (
                    ...
                    switch (w) {
                      case 1:
                        ((M = h), (C = n + -p / I), (i[0] = C), (i[1] = M));
                        break;
                      case 2:
                        ((C = u), (M = r + d * I), (i[0] = C), (i[1] = M));
                        break;
                      case 3:
                        ((M = g), (C = n + p / I), (i[0] = C), (i[1] = M));
                        break;
                      case 4:
                        ((C = c), (M = r + -d * I), (i[0] = C), (i[1] = M));
                    }
                  if (!L)
                    switch (R) {
                      case 1:
                        ((G = y), (x = o + -T / I), (i[2] = x), (i[3] = G));
                        break;
                      case 2:
                        ((x = v), (G = s + N * I), (i[2] = x), (i[3] = G));
                        break;
                      case 3:
                        ((G = _), (x = o + T / I), (i[2] = x), (i[3] = G));
                        break;
                      case 4:
                        ((x = m), (G = s + -N * I), (i[2] = x), (i[3] = G));
                    }
                }
                return !1;
              }),
              ...
              (r.getIntersection = function (t, e, i, r) {
                ...
                var o,
                  ...
                  _ = r.y;
                return 0 ===
                  (g = (o = f - d) * (h = y - m) - (s = _ - E) * (a = u - p))
                  ? null
                  : new n(
                      (a * (c = m * E - y * _) - h * (l = p * d - u * f)) / g,
                      (s * l - o * c) / g,
                    );
              }),
          ...
          function (t, e, i) {
            ...
            ((u.RANDOM_SEED = 1),
              ...
              (u.prototype.newGraph = function (t) {
                return new h(null, this.graphManager, t);
              }),
              (u.prototype.newNode = function (t) {
                return new s(this.graphManager, t);
              }),
              (u.prototype.newEdge = function (t) {
              ...
              (u.prototype.positionNodesRandomly = function (t) {
                if (null == t)
              ...
              (u.prototype.createDummyNodesForBendpoints = function (t) {
                for (
                  var e = [],
                    i = t.source,
              ...
              (u.findCenterOfTree = function (t) {
                ...
                for (var s = 0; s < e.length; s++) {
                  ...
                  (n.set(c, c.getNeighborsList().size), 1 == a && i.push(c));
                }
                var h = [];
                for (h = h.concat(i); !r; ) {
                  var l = [];
              ...
              (u.prototype.setGraphManager = function (t) {
                this.graphManager = t;
              }),
              (t.exports = u));
          },
          ...
          function (t, e, i) {
            ...
            function h() {
              (n.call(this),
                ...
                (this.idealEdgeLength = r.DEFAULT_EDGE_LENGTH),
                (this.springConstant = r.DEFAULT_SPRING_STRENGTH),
                (this.repulsionConstant = r.DEFAULT_REPULSION_STRENGTH),
            ...
            ((h.prototype.initParameters = function () {
              ...
              (h.prototype.calcSpringForce = function (t, e) {
                ...
                if (
                  ...
                  return;
                0 != (i = t.getLength()) &&
                  ((r = (n = this.springConstant * (i - e)) * (t.lengthX / i)),
                  (o = n * (t.lengthY / i)),
                  (s.springForceX += r),
                  (s.springForceY += o),
                  (a.springForceX -= r),
              ...
              (h.prototype.calcRepulsionForce = function (t, e) {
                var i,
                  ...
                  f = new Array(4);
                if (u.intersects(d)) {
                  (s.calcSeparationAmount(u, d, p, r.DEFAULT_EDGE_LENGTH / 2),
                    (c = 2 * p[0]),
                    (g = 2 * p[1]));
                  var y =
                    (t.noOfChildren * e.noOfChildren) /
                    (t.noOfChildren + e.noOfChildren);
                  ((t.repulsionForceX -= y * c),
                    (t.repulsionForceY -= y * g),
                    (e.repulsionForceX += y * c),
                    (e.repulsionForceY += y * g));
                } else
                  (this.uniformLeafNodeSizes &&
                  null == t.getChild() &&
                  null == e.getChild()
                    ? ((i = d.getCenterX() - u.getCenterX()),
                      (n = d.getCenterY() - u.getCenterY()))
                    : (s.getIntersection(u, d, f),
                      (i = f[2] - f[0]),
                      (n = f[3] - f[1])),
          ...
          function (t, e, i) {
            ...
            for (var o in ((r.prototype = Object.create(n.prototype)), n))
              r[o] = n[o];
            ((r.prototype.setGridCoordinates = function (t, e, i, n) {
              ((this.startX = t),
                (this.finishX = e),
                (this.startY = i),
                (this.finishY = n));
  ...
  (T ||
    ...
    (E.exports =
            ...
            return (function (t) {
              ...
              function (t, e, i) {
                ...
                ((r.DEFAULT_USE_MULTI_LEVEL_SCALING = !1),
                  ...
                  (r.TREE_REDUCTION_ON_INCREMENTAL = !1),
                  (t.exports = r));
              },
              function (t, e, i) {
              ...
              function (t, e, i) {
                ...
                for (var _ in ((m.prototype = Object.create(n.prototype)), n))
                  m[_] = n[_];
                ((m.prototype.newGraphManager = function () {
                  var t = new r(this);
                  return ((this.graphManager = t), t);
                }),
                  (m.prototype.newGraph = function (t) {
                    return new o(null, this.graphManager, t);
                  }),
                  (m.prototype.newNode = function (t) {
                    return new s(this.graphManager, t);
                  }),
                  (m.prototype.newEdge = function (t) {
                    return new a(null, null, t);
                  }),
                  ...
                  (m.prototype.positionNodesRadially = function (t) {
                    for (
                      var e = new g(0, 0),
                  ...
                  (m.radialLayout = function (t, e, i) {
                    var n = Math.max(
                      this.maxDiagonalInTree(t),
                      h.DEFAULT_RADIAL_SEPARATION,
                    );
                    m.branchRadialLayout(e, null, 0, 359, 0, n);
                  ...
                  (m.branchRadialLayout = function (t, e, i, n, r, o) {
                    var s = (n - i + 1) / 2;
                    s < 0 && (s += 180);
                    ...
                    t.setCenter(h, l);
                    var c = [],
                      g = (c = c.concat(t.getEdges())).length;
                    null != e && g--;
                    for (
                      var u, d = 0, p = c.length, y = t.getEdgesBetween(e);
                      y.length > 1;
                    ) {
                      var E = y[0];
                      y.splice(0, 1);
                      var _ = c.indexOf(E);
                      (_ >= 0 && c.splice(_, 1), p--, g--);
                    }
                    u = null != e ? (c.indexOf(y[0]) + 1) % p : 0;
                    for (
                      var v = Math.abs(n - i) / g, N = u;
                      d != g;
                      N = ++N % p
                    ) {
                      var T = c[N].getOtherEnd(t);
                      if (T != e) {
                        var A = (i + d * v) % 360,
                          L = (A + v) % 360;
                        (m.branchRadialLayout(T, t, A, L, r + o, o), d++);
                      }
                    }
                  }),
                  (m.maxDiagonalInTree = function (t) {
                  ...
                  (m.prototype.repopulateZeroDegreeMembers = function () {
                    ...
                    Object.keys(e).forEach(function (i) {
                      var n = t.idToDummyNode[i],
                        r = n.paddingLeft,
                        o = n.paddingTop;
                      t.adjustLocations(e[i], n.rect.x, n.rect.y, r, o);
                    });
                  }),
                  (m.prototype.getToBeTiled = function (t) {
                    var e = t.id;
                  ...
                  (m.prototype.getNodeDegree = function (t) {
                    t.id;
                    for (
                  ...
                  (m.prototype.getNodeDegreeWithChildren = function (t) {
                  ...
                  (m.prototype.fillCompexOrderByDFS = function (t) {
                    for (var e = 0; e < t.length; e++) {
                      var i = t[e];
                      (null != i.getChild() &&
                  ...
                  (m.prototype.adjustLocations = function (t, e, i, n, r) {
                    i += r;
                    for (var o = (e += n), s = 0; s < t.rows.length; s++) {
                      var a = t.rows[s];
                      e = o;
                      for (var h = 0, l = 0; l < a.length; l++) {
                        ...
                        ((c.rect.x = e),
                          ...
                          c.rect.height > h && (h = c.rect.height));
                      }
                      i += h + t.verticalPadding;
                    }
                  }),
                  (m.prototype.tileCompoundMembers = function (t, e) {
                    var i = this;
                  ...
                  (m.prototype.tileNodes = function (t, e) {
                    var i = {
                      rows: [],
                      rowWidth: [],
                      rowHeight: [],
                    ...
                    for (var n = 0; n < t.length; n++) {
                      var r = t[n];
                      (0 == i.rows.length
                        ? this.insertNodeToRow(i, r, 0, e)
                        : this.canAddHorizontal(i, r.rect.width, r.rect.height)
                          ...
                          : this.insertNodeToRow(i, r, i.rows.length, e),
                        this.shiftToLastRow(i));
                    }
                    return i;
                  }),
                  (m.prototype.insertNodeToRow = function (t, e, i, n) {
                    var r = n;
                    i == t.rows.length &&
                      (t.rows.push([]),
                      t.rowWidth.push(r),
                  ...
                  (m.prototype.getShortestRowIndex = function (t) {
                    for (
                  ...
                  (m.prototype.getLongestRowIndex = function (t) {
                    for (
                  ...
                  (m.prototype.canAddHorizontal = function (t, e, i) {
                    ...
                    return (
                      t.rowHeight[n] < i &&
                        n > 0 &&
                        (a = i + t.verticalPadding - t.rowHeight[n]),
                      (o =
                        t.width - r >= e + t.horizontalPadding
                          ? (t.height + a) / (r + e + t.horizontalPadding)
                          : (t.height + a) / t.width),
                  ...
                  (m.prototype.shiftToLastRow = function (t) {
                    ...
                    for (var t, e = [], i = !0; i; ) {
                      ...
                      for (var o = 0; o < n.length; o++)
                        1 != (t = n[o]).getEdges().length ||
                          ...
                          null != t.getChild() ||
                          (r.push([t, t.getEdges()[0], t.getOwner()]),
                          (i = !0));
                      if (1 == i) {
                        for (var s = [], a = 0; a < r.length; a++)
                          1 == r[a][0].getEdges().length &&
                            (s.push(r[a]), r[a][0].getOwner().remove(r[a][0]));
                        (e.push(s),
                          this.graphManager.resetAllNodes(),
                          this.graphManager.resetAllEdges());
                      }
                  ...
                  (m.prototype.growTree = function (t) {
                  ...
                  (m.prototype.findPlaceforPrunedNode = function (t) {
                    var e,
                      i,
                      n = t[0],
                      r = (i = n == t[1].source ? t[1].target : t[1].source)
                        .startX,
                      o = i.finishX,
                      s = i.startY,
                      a = i.finishY,
                    ...
                    if (r > 0)
                      for (c = s; c <= a; c++)
                        h[3] +=
                          ...
                          1;
                    for (var g, u, d = p.MAX_VALUE, f = 0; f < h.length; f++)
                      h[f] < d
                        ? ((d = h[f]), (g = 1), (u = f))
                        : h[f] == d && g++;
                    if (3 == g && 0 == d)
      ...
      (function (t) {
        ...
        function (t, e, i) {
          var n = i(0).layoutBase.LayoutConstants,
            r = i(0).layoutBase.FDLayoutConstants,
            o = i(0).CoSEConstants,
            s = i(0).CoSELayout,
            a = i(0).CoSENode,
          ...
          var u = function (t) {
            (null != t.nodeRepulsion &&
              (o.DEFAULT_REPULSION_STRENGTH = r.DEFAULT_REPULSION_STRENGTH =
                t.nodeRepulsion),
              null != t.idealEdgeLength &&
                (o.DEFAULT_EDGE_LENGTH = r.DEFAULT_EDGE_LENGTH =
                  t.idealEdgeLength),
              null != t.edgeElasticity &&
                (o.DEFAULT_SPRING_STRENGTH = r.DEFAULT_SPRING_STRENGTH =
                  t.edgeElasticity),
              null != t.nestingFactor &&
                (o.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                  r.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                    t.nestingFactor),
              null != t.gravity &&
                (o.DEFAULT_GRAVITY_STRENGTH = r.DEFAULT_GRAVITY_STRENGTH =
                  t.gravity),
              null != t.numIter &&
                (o.MAX_ITERATIONS = r.MAX_ITERATIONS = t.numIter),
              null != t.gravityRange &&
              ...
              (o.DEFAULT_INCREMENTAL =
                ...
                n.DEFAULT_INCREMENTAL =
                  !t.randomize),
              (o.ANIMATE = r.ANIMATE = n.ANIMATE = t.animate),
              (o.TILE = t.tile),
          ...
          ((g.prototype.run = function () {
            ...
            ((this.root = o.addRoot()),
              this.processChildrenList(this.root, this.getTopMostNodes(a), n));
            for (var l = 0; l < h.length; l++) {
              var c = h[l],
                g = this.idToLNode[c.data("source")],
                u = this.idToLNode[c.data("target")];
              g !== u &&
                0 == g.getEdgesBetween(u).length &&
                (o.add(n.newEdge(), g, u).id = c.id());
            }
            var d = function (t, e) {
                "number" == typeof t && (t = e);
                var i = t.data("id"),
              ...
              p = function o() {
                for (
                  var s,
                    a = function () {
                      (i.fit && i.cy.fit(i.eles, i.padding),
                        t ||
                          ((t = !0),
                          r.cy.one("layoutready", i.ready),
                          r.cy.trigger({ type: "layoutready", layout: r })));
                    },
                    h = r.options.refresh,
                    l = 0;
                  l < h && !s;
                  ...
                  s = r.stopped || r.layout.tick();
                if (s)
                  return (
                    n.checkLayoutSuccess() &&
                      !n.isSubLayout &&
                      n.doPostLayout(),
                    n.tilingPostLayout && n.tilingPostLayout(),
                    (n.isLayoutFinished = !0),
                    r.options.eles.nodes().positions(d),
                    a(),
                    r.cy.one("layoutstop", r.options.stop),
                    r.cy.trigger({ type: "layoutstop", layout: r }),
                    e && cancelAnimationFrame(e),
                    void (t = !1)
                  );
                var c = r.layout.getPositionsData();
                (i.eles.nodes().positions(function (t, e) {
                  if (("number" == typeof t && (t = e), !t.isParent())) {
                    for (
                      var i = t.id(), n = c[i], r = t;
                      null == n &&
                      ((n =
                        c[r.data("parent")] ||
                        c["DummyCompound_" + r.data("parent")]),
                      (c[i] = n),
                      null != (r = r.parent()[0]));
                    );
                    return null != n
            ...
            (g.prototype.processChildrenList = function (t, e, i) {
              for (var n = e.length, r = 0; r < n; r++) {
                var o,
                  s,
                  c = e[r],
                  g = c.children(),
                  u = c.layoutDimensions({
                ...
                if (
                  (((o =
                    null != c.outerWidth() && null != c.outerHeight()
                      ...
                      : t.add(new a(this.graphManager))).id = c.data("id")),
                  (o.paddingLeft = parseInt(c.css("padding"))),
                  (o.paddingTop = parseInt(c.css("padding"))),
                  (o.paddingRight = parseInt(c.css("padding"))),
                  (o.paddingBottom = parseInt(c.css("padding"))),
...
var O = (function () {
  var t = e(function (t, e, i, n) {
    ...
    m = {
      ...
      performAction: e(function (t, e, i, n, r, o, s) {
        var a = o.length - 1;
        switch (r) {
          case 6:
          case 7:
          ...
          case 12:
            ...
            break;
          case 15:
            (n.getLogger().info("Node: ", o[a].id),
              n.addNode(o[a - 1].length, o[a].id, o[a].descr, o[a].type));
            break;
          case 16:
            (n.getLogger().trace("Icon: ", o[a]),
              n.decorateNode({ icon: o[a] }));
            break;
          case 17:
          case 21:
            n.decorateNode({ class: o[a] });
            break;
          case 18:
            n.getLogger().trace("SPACELIST");
            break;
          case 19:
            (n.getLogger().trace("Node: ", o[a].id),
              n.addNode(0, o[a].id, o[a].descr, o[a].type));
            break;
          case 20:
            n.decorateNode({ icon: o[a] });
            break;
          case 25:
            (n.getLogger().trace("node found ..", o[a - 2]),
              (this.$ = {
                id: o[a - 1],
                descr: o[a - 1],
                type: n.getType(o[a - 2], o[a]),
              }));
            break;
          case 26:
            this.$ = { id: o[a], descr: o[a], type: n.nodeType.DEFAULT };
            break;
          case 27:
            (n.getLogger().trace("node found ..", o[a - 3]),
              (this.$ = {
                id: o[a - 3],
                descr: o[a - 1],
                type: n.getType(o[a - 2], o[a]),
      ...
      parse: e(function (t) {
        ...
        ("function" == typeof d.yy.parseError
          ...
          e(E, "lex"));
        for (var m, _, v, N, T, A, L, O, D = {}; ; ) {
          if (
            ((_ = n[n.length - 1]),
            this.defaultActions[_]
              ? (v = this.defaultActions[_])
              : (null == m && (m = E()), (v = a[_] && a[_][m])),
          ...
          switch (v[0]) {
            ...
            case 2:
              if (
                ...
                y &&
                  (D._$.range = [
                    s[s.length - (A || 1)].range[0],
                    s[s.length - 1].range[1],
                  ]),
                void 0 !==
                  (N = this.performAction.apply(
                    D,
                    [h, c, l, d.yy, v[1], o, s].concat(g),
                  )))
              )
                return N;
              (A &&
    ...
    _ = (function () {
      return {
        ...
        next: e(function () {
          ...
          for (var r = this._currentRules(), o = 0; o < r.length; o++)
            if (
              ...
              if (((e = i), (n = o), this.options.backtrack_lexer)) {
                if (!1 !== (t = this.test_match(i, r[o]))) return t;
                if (this._backtrack) {
                  e = !1;
                  continue;
                }
        ...
        performAction: e(function (t, e, i, n) {
          switch (i) {
            case 0:
...
var D = O,
  ...
  w =
    (e(
      (t = class {
        ...
        addNode(t, e, r, o) {
          i.info("addNode", t, e, r, o);
          const h = n();
          let l = h.mindmap?.padding ?? s.mindmap.padding;
          switch (o) {
          ...
          const c = {
              ...
              type: o,
              children: [],
              width: h.mindmap?.maxNodeWidth ?? s.mindmap.maxNodeWidth,
              padding: l,
            },
            g = this.getParent(t);
          if (g) (g.children.push(c), this.nodes.push(c));
          else {
            if (0 !== this.nodes.length)
              throw new Error(
        ...
        getType(t, e) {
          switch ((i.debug("In get type", t, e), t)) {
            case "[":
        ...
        decorateNode(t) {
          ...
          (t.icon && (i.icon = a(t.icon, e)),
            t.class && (i.class = a(t.class, e)));
        }
        type2Str(t) {
          switch (t) {
    ...
    t),
  R = e(function (t, e, i, n) {
    (e
      .append("path")
      .attr("id", "node-" + i.id)
      .attr("class", "node-bkg node-" + t.type2Str(i.type))
      .attr(
        "d",
        `M0 ${i.height - 5} v${10 - i.height} q0,-5 5,-5 h${i.width - 10} q5,0 5,5 v${i.height - 5} H0 Z`,
      ),
      e
        .append("line")
  ...
  M = e(function (t, e, i) {
    ...
    e.append("path")
      ...
      .attr(
        "d",
        `M0 0 a${o},${o} 0 0,1 ${0.25 * n},${-1 * n * 0.1}\n      a${a},${a} 1 0,1 ${0.4 * n},${-1 * n * 0.1}\n      a${s},${s} 1 0,1 ${0.35 * n},${1 * n * 0.2}\n\n      a${o},${o} 1 0,1 ${0.15 * n},${1 * r * 0.35}\n      a${h},${h} 1 0,1 ${-1 * n * 0.15},${1 * r * 0.65}\n\n      a${s},${o} 1 0,1 ${-1 * n * 0.25},${0.15 * n}\n      a${a},${a} 1 0,1 ${-1 * n * 0.5},0\n      a${o},${o} 1 0,1 ${-1 * n * 0.25},${-1 * n * 0.15}\n\n      a${o},${o} 1 0,1 ${-1 * n * 0.1},${-1 * r * 0.35}\n      a${h},${h} 1 0,1 ${0.1 * n},${-1 * r * 0.65}\n\n    H0 V0 Z`,
      );
  }, "cloudBkg"),
  x = e(function (t, e, i) {
    const n = i.width,
    ...
    e.append("path")
      ...
      .attr(
        "d",
        `M0 0 a${o},${o} 1 0,0 ${0.25 * n},${-1 * r * 0.1}\n      a${o},${o} 1 0,0 ${0.25 * n},0\n      a${o},${o} 1 0,0 ${0.25 * n},0\n      a${o},${o} 1 0,0 ${0.25 * n},${1 * r * 0.1}\n\n      a${o},${o} 1 0,0 ${0.15 * n},${1 * r * 0.33}\n      a${0.8 * o},${0.8 * o} 1 0,0 0,${1 * r * 0.34}\n      a${o},${o} 1 0,0 ${-1 * n * 0.15},${1 * r * 0.33}\n\n      a${o},${o} 1 0,0 ${-1 * n * 0.25},${0.15 * r}\n      a${o},${o} 1 0,0 ${-1 * n * 0.25},0\n      a${o},${o} 1 0,0 ${-1 * n * 0.25},0\n      a${o},${o} 1 0,0 ${-1 * n * 0.25},${-1 * r * 0.15}\n\n      a${o},${o} 1 0,0 ${-1 * n * 0.1},${-1 * r * 0.33}\n      a${0.8 * o},${0.8 * o} 1 0,0 0,${-1 * r * 0.34}\n      a${o},${o} 1 0,0 ${0.1 * n},${-1 * r * 0.33}\n\n    H0 V0 Z`,
      );
  }, "bangBkg"),
  G = e(function (t, e, i) {
    e.append("circle")
...
function S(t, e, i, n, r) {
  return t
    ...
    .attr("transform", "translate(" + (r.width - e) / 2 + ", " + i + ")");
}
e(S, "insertPolygonShape");
var b = e(function (t, e, i) {
    const n = i.height,
      r = n / 4,
      o = i.width - i.padding + 2 * r;
    S(
      e,
      o,
      n,
  ...
  P = e(async function (t, e, i, n, r) {
    const o = r.htmlLabels,
      s = n % 11,
      a = e.append("g");
    i.section = s;
    let h = "section-" + s;
    (s < 0 && (h += " section-root"),
      a.attr("class", (i.class ? i.class + " " : "") + "mindmap-node " + h));
    const l = a.append("g"),
      c = a.append("g"),
      g = i.descr.replace(/(<br\/*>)/g, "\n");
    (await u(
      c,
      g,
      { useHtmlLabels: o, width: i.width, classes: "mindmap-node-label" },
      r,
    ),
      o ||
        c
    ...
    const p = c.node().getBBox(),
      [f] = d(r.fontSize);
    if (
      ((i.height = p.height + 1.1 * f * 0.5 + i.padding),
      (i.width = p.width + 2 * i.padding),
      i.icon)
    )
      if (i.type === t.nodeType.CIRCLE) {
        ...
        (a
          ...
          .append("i")
          .attr("class", "node-icon-" + s + " " + i.icon),
          c.attr(
            "transform",
            "translate(" +
              i.width / 2 +
              ", " +
              (i.height / 2 - 1.5 * i.padding) +
              ")",
          ));
      } else {
        i.width += 50;
        const t = i.height;
        i.height = Math.max(t, 60);
        const e = Math.abs(i.height - t);
        (a
          .append("foreignObject")
          .attr("width", "60px")
          .attr("height", i.height)
      ...
      const t = (i.width - p.width) / 2,
        e = (i.height - p.height) / 2;
    ...
    return (t.setElementForId(i.id, a), i.height);
  }, "drawNode"),
  U = e(function (t, e) {
    const i = t.getElementById(e.id),
      n = e.x || 0,
      r = e.y || 0;
    i.attr("transform", "translate(" + n + "," + r + ")");
  }, "positionNode");
async function Y(t, e, i, n, r) {
  (await P(t, e, i, n, r),
    i.children &&
      (await Promise.all(
        i.children.map((i, o) => Y(t, e, i, n < 0 ? o : n, r)),
      )));
}
function k(t, e) {
  e.edges().map((e, n) => {
    ...
    if (e[0]._private.bodyBounds) {
      ...
      (i.trace("Edge: ", n, r),
        t
          ...
          .attr(
            "class",
            "edge section-edge-" + r.section + " edge-depth-" + r.depth,
          ));
    }
  });
}
...
function $(t, e) {
  e.nodes().map((e, n) => {
    const r = e.data();
    ((r.x = e.position().x), (r.y = e.position().y), U(t, r));
    const o = t.getElementById(r.nodeId);
    (i.info(
      "id:",
      n,
      "Position: (",
      ...
      o.attr(
        "transform",
        `translate(${e.position().x - r.width / 2}, ${e.position().y - r.height / 2})`,
      ),
      o.attr("attr", `apa-${n})`));
  });
}
...
var H = {
    draw: e(async (t, e, a, h) => {
      ...
      const u = r(e),
        d = u.append("g");
      d.attr("class", "mindmap-edges");
      const p = u.append("g");
      (p.attr("class", "mindmap-nodes"), await Y(l, p, c, -1, g));
      const f = await B(c, g);
      (k(d, f),
        $(l, f),
        o(
          void 0,
          u,
          g.mindmap?.padding ?? s.mindmap.padding,
          g.mindmap?.useMaxWidth ?? s.mindmap.useMaxWidth,
        ));
    }, "draw"),
  },
  W = e((t) => {
    ...
    for (let i = 0; i < t.THEME_COLOR_LIMIT; i++)
      ((t["lineColor" + i] = t["lineColor" + i] || t["cScaleInv" + i]),
        h(t["lineColor" + i])
          ? (t["lineColor" + i] = l(t["lineColor" + i], 20))
          : (t["lineColor" + i] = c(t["lineColor" + i], 20)));
    for (let i = 0; i < t.THEME_COLOR_LIMIT; i++) {
      const n = "" + (17 - 3 * i);
