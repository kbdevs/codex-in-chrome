      ...
      switch (n.label) {
        case 0:
          ((t = _(s)),
            ...
            (n.label = 1));
        case 1:
          return (n.trys.push([1, 3, , 4]), [4, i(d)]);
        case 2:
          return (
            n.sent(),
            (function (t, n, i) {
                  ...
                  null !==
                    (r =
                      null ===
                        ...
                        ? void 0
                        : e.getEntriesByName(t, "resource")) && void 0 !== r
                    ? r
                    : []
                )[0];
                s &&
...
var k = (function () {
  function i(t, n, i, e, r, o) {
    ...
    ((this.options = {}),
      ...
      (this.version = n),
      (this.settings = u({}, e)),
      (this.disableAutoISOConversion = r.disableAutoISOConversion || !1),
  ...
  return (
    ...
    (i.prototype.shouldBuffer = function (t) {
      return (
        "page" !== t.event.type &&
        (a() || !0 !== this._ready || !0 !== this._initialized)
      );
    }),
        ...
        return n(this, function (n) {
          switch (n.label) {
            ...
            case 1:
              ...
              ((f = new e(v, { traverse: !this.disableAutoISOConversion })),
                s(i, {
                  integrationName: this.name,
                  methodName: r,
                  type: "classic",
            ...
            case 2:
              return (
                n.trys.push([2, 5, , 6]),
                this.integration
                  ? [4, this.integration.invoke.call(this.integration, r, f)]
                  : [3, 4]
              );
            case 3:
              (n.sent(), (n.label = 4));
        ...
        setTimeout(function () {
          return t(i, void 0, void 0, function () {
            ...
            return n(this, function (n) {
              switch (n.label) {
                case 0:
                  return a() || !0 !== this._ready || !0 !== this._initialized
                    ? (this.scheduleFlush(), [2])
                    : ((this.flushing = !0),
                      (t = this),
                      [4, j(this, this.buffer)]);
                case 1:
                  return (
                    (t.buffer = n.sent()),
                    (this.flushing = !1),
...
function N(t, n, i, e, r, s) {
  var a, c;
  if ((void 0 === i && (i = {}), void 0 === e && (e = {}), h())) return [];
  n.plan && ((e = null != e ? e : {}).plan = n.plan);
  var l =
      null !==
        (c =
  ...
  return Array.from(y)
    ...
    .map(function (n) {
      var i = (function (t) {
        ...
        o = new k(n, i, t, g[n], e, null == m ? void 0 : m[n]);
      return (
        l.filter(function (t) {
...
export { k as LegacyDestination, N as ajsDestinations };
