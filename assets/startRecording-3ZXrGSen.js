...
const It = /url\((?:(')([^']*)'|(")([^"]*)"|([^)]*))\)/gm,
  ...
  bt = /^["']?data:.*,/i;
function Tt(t, e) {
  return t.replace(It, (t, o, s, r, i, a) => {
    const c = s || i || a;
    if (!e || !c || Nt.test(c) || bt.test(c)) return t;
    const u = o || r || "";
...
function At(t) {
  ...
  if (!e) return null;
  return Tt(Array.from(e, a() ? kt : Pt).join(""), t.href);
}
function kt(t) {
  if (
    (function (t) {
...
function jt(t, e) {
  const { throttled: n, cancel: o } = I(
      (n) => {
        ...
        t(Wt(Xt(n) ? ht : dt, { positions: [i] }));
      },
      50,
      { trailing: !1 },
    ),
    { stop: s } = N(e.configuration, document, ["mousemove", "touchmove"], n, {
      capture: !0,
      passive: !0,
    });
  return {
...
function Kt(t, e) {
  return N(
    ...
    (n) => {
      ...
      t({ id: e.eventIds.getIdForEvent(n), ...Wt(lt, a) });
    },
    { capture: !0, passive: !0 },
  );
}
function Zt(t, e, n) {
  const { throttled: s, cancel: r } = I((t) => {
      const s = Yt(t);
      if (!s) return;
      ...
      (n.elementsScrollPositions.set(s, i),
        e(Wt(ft, { id: r, x: i.scrollLeft, y: i.scrollTop })));
    }, 100),
...
function te(t, e) {
  ...
  const { throttled: o, cancel: s } = I(
    ...
    { stop: r } = N(e.configuration, n, ["resize", "scroll"], o, {
      capture: !0,
      passive: !0,
    });
  return {
...
function ee(t, e) {
  return N(
    ...
    (n) => {
      ...
      void 0 !== r &&
        b(s, e.configuration.defaultPrivacyLevel) !== o.HIDDEN &&
        t(Wt(gt, { id: r, type: "play" === n.type ? St : xt }));
    },
    { capture: !0, passive: !0 },
  );
}
  ...
  const o = [
    D(
      ...
      ({ target: e, parameters: [o, s] }) => {
        n(e, (e) => t(Wt(yt, { id: e, adds: [{ rule: o, index: s }] })));
      },
    ),
    D(
      CSSStyleSheet.prototype,
      ...
      ({ target: e, parameters: [o] }) => {
        n(e, (e) => t(Wt(yt, { id: e, removes: [{ index: o }] })));
      },
    ),
  ];
  function s(e) {
    o.push(
      D(e.prototype, "insertRule", ({ target: e, parameters: [o, s] }) => {
        n(e.parentStyleSheet, (n) => {
          ...
          r &&
            (r.push(s || 0),
            t(Wt(yt, { id: n, adds: [{ rule: o, index: r }] })));
        });
      }),
      D(e.prototype, "deleteRule", ({ target: e, parameters: [o] }) => {
        n(e.parentStyleSheet, (n) => {
          const s = oe(e);
          s && (s.push(o), t(Wt(yt, { id: n, removes: [{ index: s }] })));
        });
      }),
    );
  }
...
function se(t, e) {
  return N(e.configuration, window, ["focus", "blur"], () => {
...
function ae(e, n, s) {
  ...
  if (a) u = R;
    ...
    const t = [
      L(HTMLInputElement.prototype, "value", d),
      L(HTMLInputElement.prototype, "checked", d),
      L(HTMLSelectElement.prototype, "value", d),
      L(HTMLTextAreaElement.prototype, "value", d),
      L(HTMLSelectElement.prototype, "selectedIndex", d),
    ];
    u = () => {
      t.forEach((t) => t.stop());
    };
...
function ce(t, e, n, s) {
  ...
  const i = (function (t) {
      ...
      const { throttled: s, cancel: r } = I(o, 16, { leading: !1 });
      return {
        addMutations: (t) => {
          (0 === n.length && (e = O(s, { timeout: 100 })), n.push(...t));
        },
        flush: o,
        stop: () => {
          (e(), r());
      ...
      $t(2, e, n, s, (e) =>
        (function (t, e) {
          ...
          e.add(Wt(ut, { adds: r, removes: i, texts: u, attributes: d }));
        })(t.concat(a.takeRecords()), e),
      );
    }),
    a = new r(k(i.addMutations));
  return (
    a.observe(t, {
      attributeOldValue: !0,
      attributes: !0,
    ...
    const l = (function (t, e) {
      ...
      const { unsubscribe: n } = e.subscribe((t) => {
        if (
          ...
          X("Segment network request metrics", { metrics: s });
        }
        var e, n, o;
      });
      return { stop: n };
